...
namespace Org.Jsoup.Helper {
    ...
    public sealed class DataUtil {
        ...
        public static Document Load(FileInfo @in, String charsetName, String baseUri) {
            ...
            return ParseByteData(byteData, charsetName, baseUri, Org.Jsoup.Parser.Parser.HtmlParser());
        }
        ...
        /// <returns>Document</returns>
        /// <exception cref="System.IO.IOException">on IO error</exception>
        public static Document Load(Stream @in, String charsetName, String baseUri, Org.Jsoup.Parser.Parser parser
            ) {
            ByteBuffer byteData = ReadToByteBuffer(@in);
        ...
        internal static Document ParseByteData(ByteBuffer byteData, String charsetName, String baseUri, Org.Jsoup.Parser.Parser
             parser) {
            String docData;
            Document doc = null;
            ...
            if (charsetName == null) {
                ...
                docData = System.Text.Encoding.GetEncoding(defaultCharset).Decode(byteData).ToString();
                ...
                if (foundCharset != null && !foundCharset.Equals(defaultCharset)) {
                    ...
                    byteData.Rewind();
                    docData = System.Text.Encoding.GetEncoding(foundCharset).Decode(byteData).ToString();
                    doc = null;
                }
            }
            else {
                ...
                docData = System.Text.Encoding.GetEncoding(charsetName).Decode(byteData).ToString();
            }
            if (doc == null) {
                doc = parser.ParseInput(docData, baseUri);
