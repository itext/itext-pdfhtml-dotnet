    ...
    public class Whitelist {
        ...
        */
        ...
        public static Org.Jsoup.Safety.Whitelist Basic() {
            return new Org.Jsoup.Safety.Whitelist().AddTags("a", "b", "blockquote", "br", "cite", "code", "dd", "dl", 
                "dt", "em", "i", "li", "ol", "p", "pre", "q", "small", "span", "strike", "strong", "sub", "sup", "u", 
                "ul").AddAttributes("a", "href").AddAttributes("blockquote", "cite").AddAttributes("q", "cite").AddProtocols
                ("a", "href", "ftp", "http", "https", "mailto").AddProtocols("blockquote", "cite", "http", "https").AddProtocols
                ("cite", "cite", "http", "https").AddEnforcedAttribute("a", "rel", "nofollow");
        }
        ...
        public static Org.Jsoup.Safety.Whitelist Relaxed() {
            return new Org.Jsoup.Safety.Whitelist().AddTags("a", "b", "blockquote", "br", "caption", "cite", "code", "col"
                , "colgroup", "dd", "div", "dl", "dt", "em", "h1", "h2", "h3", "h4", "h5", "h6", "i", "img", "li", "ol"
                , "p", "pre", "q", "small", "span", "strike", "strong", "sub", "sup", "table", "tbody", "td", "tfoot", 
                "th", "thead", "tr", "u", "ul").AddAttributes("a", "href", "title").AddAttributes("blockquote", "cite"
                ).AddAttributes("col", "span", "width").AddAttributes("colgroup", "span", "width").AddAttributes("img"
                , "align", "alt", "height", "src", "title", "width").AddAttributes("ol", "start", "type").AddAttributes
        ...
        public virtual Org.Jsoup.Safety.Whitelist AddTags(params String[] tags) {
        ...
        /// <returns>this (for chaining)</returns>
        public virtual Org.Jsoup.Safety.Whitelist RemoveTags(params String[] tags) {
            Validate.NotNull(tags);
        ...
        /// <returns>this (for chaining)</returns>
        public virtual Org.Jsoup.Safety.Whitelist AddAttributes(String tag, params String[] keys) {
            Validate.NotEmpty(tag);
        ...
        /// <returns>this (for chaining)</returns>
        public virtual Org.Jsoup.Safety.Whitelist RemoveAttributes(String tag, params String[] keys) {
            Validate.NotEmpty(tag);
            Validate.NotNull(keys);
            Validate.IsTrue(keys.Length > 0, "No attributes supplied.");
            Whitelist.TagName tagName = Whitelist.TagName.ValueOf(tag);
        ...
        /// <returns>this (for chaining)</returns>
        public virtual Org.Jsoup.Safety.Whitelist AddEnforcedAttribute(String tag, String key, String value) {
            Validate.NotEmpty(tag);
            Validate.NotEmpty(key);
        ...
        /// <param name="key">The attribute key</param>
        /// <returns>this (for chaining)</returns>
        public virtual Org.Jsoup.Safety.Whitelist RemoveEnforcedAttribute(String tag, String key) {
            Validate.NotEmpty(tag);
            Validate.NotEmpty(key);
            Whitelist.TagName tagName = Whitelist.TagName.ValueOf(tag);
        ...
        public virtual Org.Jsoup.Safety.Whitelist PreserveRelativeLinks(bool preserve) {
        ...
        /// <returns>this, for chaining</returns>
        public virtual Org.Jsoup.Safety.Whitelist AddProtocols(String tag, String key, params String[] protocols) {
            Validate.NotEmpty(tag);
            Validate.NotEmpty(key);
        ...
        /// <returns>this, for chaining</returns>
        public virtual Org.Jsoup.Safety.Whitelist RemoveProtocols(String tag, String key, params String[] protocols
            ) {
            Validate.NotEmpty(tag);
            Validate.NotEmpty(key);
            Validate.NotNull(protocols);
        ...
        /// <returns>true if allowed</returns>
        protected internal virtual bool IsSafeAttribute(String tagName, Element el, Org.Jsoup.Nodes.Attribute attr
            ) {
        ...
        private bool TestValidProtocol(Element el, Org.Jsoup.Nodes.Attribute attr, ICollection<Whitelist.Protocol>
             protocols) {
