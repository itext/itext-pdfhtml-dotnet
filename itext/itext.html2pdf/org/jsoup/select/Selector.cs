...
namespace Org.Jsoup.Select {
    ...
    /// <seealso cref="Org.Jsoup.Nodes.Element.Select(System.String)"/>
    public class Selector {
        ...
        public static Elements Select(String query, IEnumerable<Element> roots) {
            ...
            IdentityDictionary<Element, bool?> seenElements = new IdentityDictionary<Element, bool?>();
        ...
        internal static Elements FilterOut(ICollection<Element> elements, ICollection<Element> outs) {
