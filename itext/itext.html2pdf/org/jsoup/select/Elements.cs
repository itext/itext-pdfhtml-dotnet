...
namespace Org.Jsoup.Select {
    /// <summary>
    /// A list of
    /// <see cref="Org.Jsoup.Nodes.Element"/>
    /// s, with methods that act on every element in the list.
    /// <p>
    /// To get an
    /// <c>Elements</c>
    /// object, use the
    /// <see cref="Org.Jsoup.Nodes.Element.Select(System.String)"/>
    /// method.
    /// </p>
    /// </summary>
    ...
    public class Elements : List<Element>, ICloneable {
        ...
        public virtual Org.Jsoup.Select.Elements Attr(String attributeKey, String attributeValue) {
            foreach (Element element in this) {
        ...
        public virtual Org.Jsoup.Select.Elements RemoveAttr(String attributeKey) {
            foreach (Element element in this) {
        ...
        /// <returns>this</returns>
        public virtual Org.Jsoup.Select.Elements AddClass(String className) {
            foreach (Element element in this) {
        ...
        /// <returns>this</returns>
        public virtual Org.Jsoup.Select.Elements RemoveClass(String className) {
            foreach (Element element in this) {
        ...
        /// <returns>this</returns>
        public virtual Org.Jsoup.Select.Elements ToggleClass(String className) {
            foreach (Element element in this) {
        ...
        /// <seealso cref="Org.Jsoup.Nodes.Element.Val()"/>
        ...
        /// <returns>this (for chaining)</returns>
        public virtual Org.Jsoup.Select.Elements Val(String value) {
            foreach (Element element in this) {
                element.Val(value);
            }
            return this;
        ...
        /// <seealso cref="Org.Jsoup.Nodes.Element.Text()"/>
        ...
        /// <returns>this, for chaining</returns>
        /// <seealso cref="Org.Jsoup.Nodes.Element.TagName(System.String)"/>
        public virtual Org.Jsoup.Select.Elements TagName(String tagName) {
            foreach (Element element in this) {
        ...
        /// <returns>this, for chaining</returns>
        /// <seealso cref="Org.Jsoup.Nodes.Element.Html(System.String)"/>
        public virtual Org.Jsoup.Select.Elements Html(String html) {
            foreach (Element element in this) {
                element.Html(html);
            }
            return this;
        ...
        /// <returns>this, for chaining</returns>
        /// <seealso cref="Org.Jsoup.Nodes.Element.Prepend(System.String)"/>
        public virtual Org.Jsoup.Select.Elements Prepend(String html) {
            foreach (Element element in this) {
        ...
        /// <returns>this, for chaining</returns>
        /// <seealso cref="Org.Jsoup.Nodes.Element.Append(System.String)"/>
        public virtual Org.Jsoup.Select.Elements Append(String html) {
            foreach (Element element in this) {
                element.Append(html);
            }
            return this;
        ...
        /// <returns>this, for chaining</returns>
        /// <seealso cref="Org.Jsoup.Nodes.Element.Before(System.String)"/>
        public virtual Org.Jsoup.Select.Elements Before(String html) {
            foreach (Element element in this) {
                element.Before(html);
            }
            return this;
        ...
        /// <returns>this, for chaining</returns>
        /// <seealso cref="Org.Jsoup.Nodes.Element.After(System.String)"/>
        public virtual Org.Jsoup.Select.Elements After(String html) {
            foreach (Element element in this) {
                element.After(html);
            }
            return this;
        ...
        /// </param>
        /// <returns>this (for chaining)</returns>
        /// <seealso cref="Org.Jsoup.Nodes.Element.Wrap(System.String)"/>
        public virtual Org.Jsoup.Select.Elements Wrap(String html) {
        ...
        /// </remarks>
        /// <returns>this (for chaining)</returns>
        /// <seealso cref="Org.Jsoup.Nodes.Node.Unwrap()"/>
        public virtual Org.Jsoup.Select.Elements Unwrap() {
            foreach (Element element in this) {
                element.Unwrap();
            }
            return this;
        ...
        /// </remarks>
        /// <returns>this, for chaining</returns>
        /// <seealso cref="Org.Jsoup.Nodes.Element.Empty()"/>
        /// <seealso cref="Remove()"/>
        public virtual Org.Jsoup.Select.Elements Empty() {
            foreach (Element element in this) {
                element.Empty();
            }
            return this;
        ...
        /// <see cref="Org.Jsoup.Safety.Cleaner"/>
        /// to clean HTML.
        /// </remarks>
        /// <returns>this, for chaining</returns>
        /// <seealso cref="Org.Jsoup.Nodes.Element.Empty()"/>
        /// <seealso cref="Empty()"/>
        public virtual Org.Jsoup.Select.Elements Remove() {
            foreach (Element element in this) {
                element.Remove();
            }
            return this;
        ...
        public virtual Org.Jsoup.Select.Elements Select(String query) {
        ...
        public virtual Org.Jsoup.Select.Elements Not(String query) {
        ...
        ///     </returns>
        public virtual Org.Jsoup.Select.Elements Eq(int index) {
            return Count > index ? new Org.Jsoup.Select.Elements(this[index]) : new Org.Jsoup.Select.Elements();
        }
        ...
        public virtual Org.Jsoup.Select.Elements Parents() {
        ...
        /// <returns>this, for chaining</returns>
        public virtual Org.Jsoup.Select.Elements Traverse(NodeVisitor nodeVisitor) {
        ...
        /// <summary>
        /// Get the
        /// <see cref="Org.Jsoup.Nodes.FormElement"/>
