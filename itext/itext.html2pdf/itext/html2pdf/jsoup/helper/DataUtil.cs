...
namespace iText.Html2pdf.Jsoup.Helper {
    ...
    public sealed class DataUtil {
        ...
        public static Document Load(FileInfo @in, String charsetName, String baseUri) {
            ...
            return ParseByteData(byteData, charsetName, baseUri, iText.Html2pdf.Jsoup.Parser.Parser.HtmlParser());
        }
        ...
        /// <returns>Document</returns>
        /// <exception cref="System.IO.IOException">on IO error</exception>
        public static Document Load(Stream @in, String charsetName, String baseUri, iText.Html2pdf.Jsoup.Parser.Parser
             parser) {
            ByteBuffer byteData = ReadToByteBuffer(@in);
        ...
        internal static Document ParseByteData(ByteBuffer byteData, String charsetName, String baseUri, iText.Html2pdf.Jsoup.Parser.Parser
             parser) {
            String docData;
            Document doc = null;
