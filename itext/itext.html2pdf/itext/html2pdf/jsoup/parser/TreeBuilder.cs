...
namespace iText.Html2pdf.Jsoup.Parser {
    ...
    public abstract class TreeBuilder {
        ...
        protected internal List<iText.Html2pdf.Jsoup.Nodes.Element> stack;
        ...
        internal virtual void InitialiseParse(String input, String baseUri, ParseErrorList errors) {
            ...
            stack = new List<iText.Html2pdf.Jsoup.Nodes.Element>(32);
        ...
        protected internal virtual void RunParser() {
            while (true) {
                ...
                Process(token);
                token.Reset();
                if (token.type == iText.Html2pdf.Jsoup.Parser.TokenType.EOF) {
                    break;
                }
            }
        }
        ...
        protected internal virtual iText.Html2pdf.Jsoup.Nodes.Element CurrentElement() {
