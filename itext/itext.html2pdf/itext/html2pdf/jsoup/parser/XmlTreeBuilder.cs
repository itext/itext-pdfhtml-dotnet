...
namespace iText.Html2pdf.Jsoup.Parser {
    ...
    public class XmlTreeBuilder : TreeBuilder {
        ...
        internal virtual void Insert(Token.Comment commentToken) {
            ...
            if (commentToken.bogus) {
                ...
                if (data.Length > 1 && (data.StartsWith("!") || data.StartsWith("?"))) {
                    Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<" + data.JSubstring(1, data.Length - 1) + ">", baseUri, 
                        iText.Html2pdf.Jsoup.Parser.Parser.XmlParser());
                    iText.Html2pdf.Jsoup.Nodes.Element el = doc.Child(0);
        ...
        private void PopStackToClose(Token.EndTag endTag) {
            ...
            iText.Html2pdf.Jsoup.Nodes.Element firstFound = null;
