...
namespace iText.Html2pdf.Jsoup.Parser {
    /// <summary>
    /// Parses HTML into a
    /// <see cref="iText.Html2pdf.Jsoup.Nodes.Document"/>
    ...
    public class Parser {
        ...
        public virtual iText.Html2pdf.Jsoup.Parser.Parser SetTreeBuilder(TreeBuilder treeBuilder) {
            this.treeBuilder = treeBuilder;
            return this;
        }
        ...
        /// <returns>this, for chaining</returns>
        public virtual iText.Html2pdf.Jsoup.Parser.Parser SetTrackErrors(int maxErrors) {
        ...
        ///     </returns>
        public static IList<Node> ParseFragment(String fragmentHtml, iText.Html2pdf.Jsoup.Nodes.Element context, String
             baseUri) {
        ...
        ///     </param>
        /// <returns>parsed Document</returns>
        [System.ObsoleteAttribute(@"Use ParseBodyFragment(System.String, System.String) or ParseFragment(System.String, iText.Html2pdf.Jsoup.Nodes.Element, System.String) instead."
            )]
        ...
        public static iText.Html2pdf.Jsoup.Parser.Parser HtmlParser() {
            return new iText.Html2pdf.Jsoup.Parser.Parser(new HtmlTreeBuilder());
        }
        ...
        public static iText.Html2pdf.Jsoup.Parser.Parser XmlParser() {
            return new iText.Html2pdf.Jsoup.Parser.Parser(new XmlTreeBuilder());
        }
    }
}
