...
namespace iText.Html2pdf.Jsoup.Parser {
    ...
    public class Tag {
        private static readonly IDictionary<String, iText.Html2pdf.Jsoup.Parser.Tag> tags = new Dictionary<String, 
            iText.Html2pdf.Jsoup.Parser.Tag>();
        ...
        public static iText.Html2pdf.Jsoup.Parser.Tag ValueOf(String tagName) {
            Validate.NotNull(tagName);
            iText.Html2pdf.Jsoup.Parser.Tag tag = tags.Get(tagName);
            if (tag == null) {
                ...
                if (tag == null) {
                    ...
                    tag = new iText.Html2pdf.Jsoup.Parser.Tag(tagName);
                    tag.isBlock = false;
        ...
        internal virtual iText.Html2pdf.Jsoup.Parser.Tag SetSelfClosing() {
            selfClosing = true;
            return this;
        }
        ...
        public override bool Equals(Object o) {
            ...
            if (!(o is iText.Html2pdf.Jsoup.Parser.Tag)) {
                return false;
            }
            iText.Html2pdf.Jsoup.Parser.Tag tag = (iText.Html2pdf.Jsoup.Parser.Tag)o;
        ...
        static Tag() {
            ...
            foreach (String tagName in blockTags) {
                iText.Html2pdf.Jsoup.Parser.Tag tag = new iText.Html2pdf.Jsoup.Parser.Tag(tagName);
                Register(tag);
            }
        ...
        private static void Register(iText.Html2pdf.Jsoup.Parser.Tag tag) {
