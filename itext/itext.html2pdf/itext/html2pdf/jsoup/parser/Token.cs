...
namespace iText.Html2pdf.Jsoup.Parser {
    ...
    internal abstract class Token {
        internal iText.Html2pdf.Jsoup.Parser.TokenType type;
        ...
        /// </remarks>
        internal abstract iText.Html2pdf.Jsoup.Parser.Token Reset();
        ...
        internal sealed class Doctype : Token {
            ...
            internal Doctype() {
                type = iText.Html2pdf.Jsoup.Parser.TokenType.Doctype;
            }
        ...
        internal abstract class Tag : Token {
            ...
            internal void NewAttribute() {
                ...
                if (pendingAttributeName != null) {
                    iText.Html2pdf.Jsoup.Nodes.Attribute attribute;
                    if (hasPendingAttributeValue) {
                        attribute = new iText.Html2pdf.Jsoup.Nodes.Attribute(pendingAttributeName, pendingAttributeValue.Length > 0 ? pendingAttributeValue
                            .ToString() : pendingAttributeValueS);
                    }
                    else {
                        if (hasEmptyAttributeValue) {
                            attribute = new iText.Html2pdf.Jsoup.Nodes.Attribute(pendingAttributeName, "");
                        }
                        else {
        ...
        internal sealed class StartTag : Token.Tag {
            internal StartTag()
                : base() {
                attributes = new Attributes();
                type = iText.Html2pdf.Jsoup.Parser.TokenType.StartTag;
            }
        ...
        internal sealed class EndTag : Token.Tag {
            internal EndTag()
                : base() {
                type = iText.Html2pdf.Jsoup.Parser.TokenType.EndTag;
            }
        ...
        internal sealed class Comment : Token {
            ...
            internal Comment() {
                type = iText.Html2pdf.Jsoup.Parser.TokenType.Comment;
            }
        ...
        internal sealed class Character : Token {
            ...
            internal Character()
                : base() {
                type = iText.Html2pdf.Jsoup.Parser.TokenType.Character;
            }
        ...
        internal sealed class EOF : Token {
            internal EOF() {
                type = iText.Html2pdf.Jsoup.Parser.TokenType.EOF;
            }
        ...
        internal bool IsDoctype() {
            return type == iText.Html2pdf.Jsoup.Parser.TokenType.Doctype;
        }
        ...
        internal bool IsStartTag() {
            return type == iText.Html2pdf.Jsoup.Parser.TokenType.StartTag;
        }
        ...
        internal bool IsEndTag() {
            return type == iText.Html2pdf.Jsoup.Parser.TokenType.EndTag;
        }
        ...
        internal bool IsComment() {
            return type == iText.Html2pdf.Jsoup.Parser.TokenType.Comment;
        }
        ...
        internal bool IsCharacter() {
            return type == iText.Html2pdf.Jsoup.Parser.TokenType.Character;
        }
        ...
        internal bool IsEOF() {
            return type == iText.Html2pdf.Jsoup.Parser.TokenType.EOF;
        }
    }
