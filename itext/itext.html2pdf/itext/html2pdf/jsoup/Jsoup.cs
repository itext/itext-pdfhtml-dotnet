...
using iText.Html2pdf.Jsoup.Safety;
...
namespace iText.Html2pdf.Jsoup {
    ...
    public class Jsoup {
        ...
        public static Document Parse(String html, String baseUri) {
            return iText.Html2pdf.Jsoup.Parser.Parser.Parse(html, baseUri);
        }
        ...
        /// <param name="parser">
        /// alternate
        /// <see cref="iText.Html2pdf.Jsoup.Parser.Parser.XmlParser()">parser</see>
        /// to use.
        /// </param>
        /// <returns>sane HTML</returns>
        public static Document Parse(String html, String baseUri, iText.Html2pdf.Jsoup.Parser.Parser parser) {
        ...
        public static Document Parse(String html) {
            return iText.Html2pdf.Jsoup.Parser.Parser.Parse(html, "");
        }
        ...
        /// <exception cref="System.IO.IOException">if the file could not be found, or read, or if the charsetName is invalid.
        ///     </exception>
        public static Document Parse(Stream @in, String charsetName, String baseUri, iText.Html2pdf.Jsoup.Parser.Parser
             parser) {
        ...
        /// <seealso cref="iText.Html2pdf.Jsoup.Nodes.Document.Body()"/>
        public static Document ParseBodyFragment(String bodyHtml, String baseUri) {
            return iText.Html2pdf.Jsoup.Parser.Parser.ParseBodyFragment(bodyHtml, baseUri);
        }
        ...
        public static Document ParseBodyFragment(String bodyHtml) {
            return iText.Html2pdf.Jsoup.Parser.Parser.ParseBodyFragment(bodyHtml, "");
        }
        ...
        /// <seealso cref="iText.Html2pdf.Jsoup.Safety.Cleaner.Clean(iText.Html2pdf.Jsoup.Nodes.Document)"/>
        ...
        /// <seealso cref="Clean(System.String, iText.Html2pdf.Jsoup.Safety.Whitelist)"/>
