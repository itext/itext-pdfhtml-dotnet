...
namespace iText.Html2pdf.Jsoup.Nodes {
    ...
    public class Attribute {
        ...
        public static iText.Html2pdf.Jsoup.Nodes.Attribute CreateFromEncoded(String unencodedKey, String encodedValue) {
            String value = Entities.Unescape(encodedValue, true);
            return new iText.Html2pdf.Jsoup.Nodes.Attribute(unencodedKey, value);
        }
        ...
        public override bool Equals(Object o) {
            ...
            if (!(o is iText.Html2pdf.Jsoup.Nodes.Attribute)) {
                return false;
            }
            iText.Html2pdf.Jsoup.Nodes.Attribute attribute = (iText.Html2pdf.Jsoup.Nodes.Attribute)o;
