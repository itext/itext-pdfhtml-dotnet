...
#endif
 {
        private static readonly IList<iText.Html2pdf.Jsoup.Nodes.Node> EMPTY_NODES = JavaCollectionsUtil.EmptyList
            <iText.Html2pdf.Jsoup.Nodes.Node>();

        internal iText.Html2pdf.Jsoup.Nodes.Node parentNode;

        internal IList<iText.Html2pdf.Jsoup.Nodes.Node> childNodes;

        internal iText.Html2pdf.Jsoup.Nodes.Attributes attributes;
        ...
        protected internal Node(String baseUri, iText.Html2pdf.Jsoup.Nodes.Attributes attributes) {
        ...
        protected internal Node(String baseUri)
            : this(baseUri, new iText.Html2pdf.Jsoup.Nodes.Attributes()) {
        }
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.Attributes Attributes() {
            return attributes;
        }
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.Node Attr(String attributeKey, String attributeValue) {
        ...
        /// <returns>this (for chaining)</returns>
        public virtual iText.Html2pdf.Jsoup.Nodes.Node RemoveAttr(String attributeKey) {
            Validate.NotNull(attributeKey);
        ...
        private sealed class _NodeVisitor_188 : NodeVisitor {
            ...
            public void Head(iText.Html2pdf.Jsoup.Nodes.Node node, int depth) {
                node.baseUri = baseUri;
            }

            public void Tail(iText.Html2pdf.Jsoup.Nodes.Node node, int depth) {
            }
        ...
        public virtual String AbsUrl(String attributeKey) {
            ...
            if (!HasAttr(attributeKey)) {
                ...
                return iText.Html2pdf.Jsoup.Helper.StringUtil.Resolve(baseUri, Attr(attributeKey));
            }
        }
        ...
        /// </returns>
        public virtual iText.Html2pdf.Jsoup.Nodes.Node ChildNode(int index) {
        ...
        public virtual IList<iText.Html2pdf.Jsoup.Nodes.Node> ChildNodes() {
        ...
        public virtual IList<iText.Html2pdf.Jsoup.Nodes.Node> ChildNodesCopy() {
            IList<iText.Html2pdf.Jsoup.Nodes.Node> children = new List<iText.Html2pdf.Jsoup.Nodes.Node>(childNodes.Count
                );
            foreach (iText.Html2pdf.Jsoup.Nodes.Node node in childNodes) {
                children.Add((iText.Html2pdf.Jsoup.Nodes.Node)node.Clone());
            }
            return children;
        }
        ...
        protected internal virtual iText.Html2pdf.Jsoup.Nodes.Node[] ChildNodesAsArray() {
            return childNodes.ToArray(new iText.Html2pdf.Jsoup.Nodes.Node[ChildNodeSize()]);
        }

        /// <summary>Gets this node's parent node.</summary>
        /// <returns>parent node; or null if no parent.</returns>
        public virtual iText.Html2pdf.Jsoup.Nodes.Node Parent() {
            return parentNode;
        }
        ...
        ///     </remarks>
        /// <returns>parent node; or null if no parent.</returns>
        public iText.Html2pdf.Jsoup.Nodes.Node ParentNode() {
            return parentNode;
        }
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.Node Before(String html) {
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.Node Before(iText.Html2pdf.Jsoup.Nodes.Node node) {
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.Node After(String html) {
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.Node After(iText.Html2pdf.Jsoup.Nodes.Node node) {
            Validate.NotNull(node);
            Validate.NotNull(parentNode);
        ...
        private void AddSiblingHtml(int index, String html) {
            ...
            Validate.NotNull(parentNode);
            iText.Html2pdf.Jsoup.Nodes.Element context = Parent() is iText.Html2pdf.Jsoup.Nodes.Element ? (iText.Html2pdf.Jsoup.Nodes.Element
                )Parent() : null;
            IList<iText.Html2pdf.Jsoup.Nodes.Node> nodes = iText.Html2pdf.Jsoup.Parser.Parser.ParseFragment(html, context
                , BaseUri());
            parentNode.AddChildren(index, nodes.ToArray(new iText.Html2pdf.Jsoup.Nodes.Node[nodes.Count]));
        }
        ...
        /// </param>
        /// <returns>this node, for chaining.</returns>
        public virtual iText.Html2pdf.Jsoup.Nodes.Node Wrap(String html) {
            Validate.NotEmpty(html);
            iText.Html2pdf.Jsoup.Nodes.Element context = Parent() is iText.Html2pdf.Jsoup.Nodes.Element ? (iText.Html2pdf.Jsoup.Nodes.Element
                )Parent() : null;
            IList<iText.Html2pdf.Jsoup.Nodes.Node> wrapChildren = iText.Html2pdf.Jsoup.Parser.Parser.ParseFragment(html
                , context, BaseUri());
            iText.Html2pdf.Jsoup.Nodes.Node wrapNode = wrapChildren[0];
            if (wrapNode == null || !(wrapNode is iText.Html2pdf.Jsoup.Nodes.Element)) {
                // nothing to wrap with; noop
                return null;
            }
            iText.Html2pdf.Jsoup.Nodes.Element wrap = (iText.Html2pdf.Jsoup.Nodes.Element)wrapNode;
            iText.Html2pdf.Jsoup.Nodes.Element deepest = GetDeepChild(wrap);
            parentNode.ReplaceChild(this, wrap);
            deepest.AddChildren(this);
            // remainder (unbalanced wrap, like <div></div><p></p> -- The <p> is remainder
            if (wrapChildren.Count > 0) {
                for (int i = 0; i < wrapChildren.Count; i++) {
                    iText.Html2pdf.Jsoup.Nodes.Node remainder = wrapChildren[i];
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.Node Unwrap() {
            Validate.NotNull(parentNode);
            iText.Html2pdf.Jsoup.Nodes.Node firstChild = childNodes.Count > 0 ? childNodes[0] : null;
            parentNode.AddChildren(siblingIndex, this.ChildNodesAsArray());
            this.Remove();
            return firstChild;
        }

        private iText.Html2pdf.Jsoup.Nodes.Element GetDeepChild(iText.Html2pdf.Jsoup.Nodes.Element el) {
            IList<iText.Html2pdf.Jsoup.Nodes.Element> children = el.Children();
            if (children.Count > 0) {
        ...
        public virtual void ReplaceWith(iText.Html2pdf.Jsoup.Nodes.Node @in) {
            Validate.NotNull(@in);
            Validate.NotNull(parentNode);
            parentNode.ReplaceChild(this, @in);
        }

        protected internal virtual void SetParentNode(iText.Html2pdf.Jsoup.Nodes.Node parentNode) {
        ...
        protected internal virtual void ReplaceChild(iText.Html2pdf.Jsoup.Nodes.Node @out, iText.Html2pdf.Jsoup.Nodes.Node
             @in) {
        ...
        protected internal virtual void RemoveChild(iText.Html2pdf.Jsoup.Nodes.Node @out) {
            Validate.IsTrue(@out.parentNode == this);
            int index = @out.siblingIndex;
        ...
        protected internal virtual void AddChildren(params iText.Html2pdf.Jsoup.Nodes.Node[] children) {
            //most used. short circuit addChildren(int), which hits reindex children and array copy
            foreach (iText.Html2pdf.Jsoup.Nodes.Node child in children) {
                ReparentChild(child);
                EnsureChildNodes();
        ...
        protected internal virtual void AddChildren(int index, params iText.Html2pdf.Jsoup.Nodes.Node[] children) {
            Validate.NoNullElements(children);
            EnsureChildNodes();
            for (int i = children.Length - 1; i >= 0; i--) {
                iText.Html2pdf.Jsoup.Nodes.Node @in = children[i];
                ReparentChild(@in);
        ...
        protected internal virtual void EnsureChildNodes() {
            if (childNodes == EMPTY_NODES) {
                childNodes = new List<iText.Html2pdf.Jsoup.Nodes.Node>(4);
            }
        }

        protected internal virtual void ReparentChild(iText.Html2pdf.Jsoup.Nodes.Node child) {
        ...
        public virtual IList<iText.Html2pdf.Jsoup.Nodes.Node> SiblingNodes() {
            if (parentNode == null) {
                return JavaCollectionsUtil.EmptyList<iText.Html2pdf.Jsoup.Nodes.Node>();
            }
            IList<iText.Html2pdf.Jsoup.Nodes.Node> nodes = parentNode.childNodes;
            IList<iText.Html2pdf.Jsoup.Nodes.Node> siblings = new List<iText.Html2pdf.Jsoup.Nodes.Node>(nodes.Count - 
                1);
            foreach (iText.Html2pdf.Jsoup.Nodes.Node node in nodes) {
                if (node != this) {
                    siblings.Add(node);
                }
            }
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.Node NextSibling() {
            if (parentNode == null) {
                return null;
            }
            // root
            IList<iText.Html2pdf.Jsoup.Nodes.Node> siblings = parentNode.childNodes;
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.Node PreviousSibling() {
            if (parentNode == null) {
                return null;
            }
            // root
        ...
        /// <returns>this node, for chaining</returns>
        public virtual iText.Html2pdf.Jsoup.Nodes.Node Traverse(NodeVisitor nodeVisitor) {
        ...
        protected internal virtual void Indent(StringBuilder accum, int depth, OutputSettings @out) {
            accum.Append("\n").Append(iText.Html2pdf.Jsoup.Helper.StringUtil.Padding(depth * @out.IndentAmount()));
        }
        ...
        public virtual bool HasSameValue(Object o) {
            ...
            return this.OuterHtml().Equals(((iText.Html2pdf.Jsoup.Nodes.Node)o).OuterHtml());
        }
        ...
        public virtual Object Clone() {
            iText.Html2pdf.Jsoup.Nodes.Node thisClone = DoClone(null);
            // splits for orphan
            // Queue up nodes that need their children cloned (BFS).
            LinkedList<iText.Html2pdf.Jsoup.Nodes.Node> nodesToProcess = new LinkedList<iText.Html2pdf.Jsoup.Nodes.Node
                >();
            nodesToProcess.Add(thisClone);
            while (!nodesToProcess.IsEmpty()) {
                iText.Html2pdf.Jsoup.Nodes.Node currParent = nodesToProcess.JRemove();
                for (int i = 0; i < currParent.childNodes.Count; i++) {
                    iText.Html2pdf.Jsoup.Nodes.Node childClone = currParent.childNodes[i].DoClone(currParent);
        ...
        */
        protected internal virtual iText.Html2pdf.Jsoup.Nodes.Node DoClone(iText.Html2pdf.Jsoup.Nodes.Node parent) {
            iText.Html2pdf.Jsoup.Nodes.Node clone;
            clone = (iText.Html2pdf.Jsoup.Nodes.Node)MemberwiseClone();
            clone.parentNode = parent;
            // can be null, to create an orphan split
            clone.siblingIndex = parent == null ? 0 : siblingIndex;
            clone.attributes = attributes != null ? (iText.Html2pdf.Jsoup.Nodes.Attributes)attributes.Clone() : null;
            clone.baseUri = baseUri;
            clone.childNodes = new List<iText.Html2pdf.Jsoup.Nodes.Node>(childNodes.Count);
            foreach (iText.Html2pdf.Jsoup.Nodes.Node child in childNodes) {
