...
namespace iText.Html2pdf.Jsoup.Nodes {
    ...
    public class Document : iText.Html2pdf.Jsoup.Nodes.Element {
        ...
        /// <seealso cref="iText.Html2pdf.Jsoup.Jsoup.Parse(System.String)"/>
        /// <seealso cref="CreateShell(System.String)"/>
        public Document(String baseUri)
            : base(iText.Html2pdf.Jsoup.Parser.Tag.ValueOf("#root"), baseUri) {
        ...
        public override Object Clone() {
            iText.Html2pdf.Jsoup.Nodes.Document clone = (iText.Html2pdf.Jsoup.Nodes.Document)base.Clone();
            clone.outputSettings = (iText.Html2pdf.Jsoup.Nodes.OutputSettings)this.outputSettings.Clone();
            return clone;
        }
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.OutputSettings OutputSettings() {
        ...
        public virtual Document OutputSettings(iText.Html2pdf.Jsoup.Nodes.OutputSettings outputSettings) {
...
#endif
 {
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.OutputSettings EscapeMode(Entities.EscapeMode escapeMode) {
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.Syntax Syntax() {
            return syntax;
        }
        ...
        /// <returns>the document's output settings, for chaining</returns>
        public virtual iText.Html2pdf.Jsoup.Nodes.OutputSettings Syntax(iText.Html2pdf.Jsoup.Nodes.Syntax syntax) {
            this.syntax = syntax;
            return this;
        }
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.OutputSettings PrettyPrint(bool pretty) {
            prettyPrint = pretty;
            return this;
        }
        ...
        /// <returns>this, for chaining</returns>
        public virtual iText.Html2pdf.Jsoup.Nodes.OutputSettings Outline(bool outlineMode) {
            outline = outlineMode;
            return this;
        }
        ...
        /// </param>
        /// <returns>this, for chaining</returns>
        public virtual iText.Html2pdf.Jsoup.Nodes.OutputSettings IndentAmount(int indentAmount) {
        ...
        public virtual Object Clone() {
            iText.Html2pdf.Jsoup.Nodes.OutputSettings clone;
            clone = (iText.Html2pdf.Jsoup.Nodes.OutputSettings)MemberwiseClone();
