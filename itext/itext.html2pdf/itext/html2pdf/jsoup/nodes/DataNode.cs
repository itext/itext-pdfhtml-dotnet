...
namespace iText.Html2pdf.Jsoup.Nodes {
    ...
    public class DataNode : Node {
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.DataNode SetWholeData(String data) {
            attributes.Put(DATA_KEY, data);
            return this;
        }
        ...
        public static iText.Html2pdf.Jsoup.Nodes.DataNode CreateFromEncoded(String encodedData, String baseUri) {
            String data = Entities.Unescape(encodedData);
            return new iText.Html2pdf.Jsoup.Nodes.DataNode(data, baseUri);
        }
    }
}
