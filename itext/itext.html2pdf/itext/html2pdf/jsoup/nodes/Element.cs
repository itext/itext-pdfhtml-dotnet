...
namespace iText.Html2pdf.Jsoup.Nodes {
    ...
    public class Element : Node {
        private iText.Html2pdf.Jsoup.Parser.Tag tag;
        ...
        public Element(iText.Html2pdf.Jsoup.Parser.Tag tag, String baseUri, Attributes attributes)
        ...
        /// string, but not null.
        /// </param>
        /// <seealso cref="iText.Html2pdf.Jsoup.Parser.Tag.ValueOf(System.String)"/>
        public Element(iText.Html2pdf.Jsoup.Parser.Tag tag, String baseUri)
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.Element TagName(String tagName) {
            Validate.NotEmpty(tagName, "Tag name must not be empty.");
            tag = iText.Html2pdf.Jsoup.Parser.Tag.ValueOf(tagName);
            return this;
        }

        /// <summary>Get the Tag for this element.</summary>
        /// <returns>the tag object</returns>
        public virtual iText.Html2pdf.Jsoup.Parser.Tag Tag() {
            return tag;
        }
        ...
        /// <returns>this element</returns>
        public virtual iText.Html2pdf.Jsoup.Nodes.Element Attr(String attributeKey, bool attributeValue) {
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.Element Child(int index) {
        ...
        /// <see cref="iText.Html2pdf.Jsoup.Select.Selector"/>
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.Element AppendChild(Node child) {
        ...
        /// <returns>this element</returns>
        public virtual iText.Html2pdf.Jsoup.Nodes.Element AppendText(String text) {
        ...
        /// <param name="text">the unencoded text to add</param>
        /// <returns>this element</returns>
        public virtual iText.Html2pdf.Jsoup.Nodes.Element PrependText(String text) {
            Validate.NotNull(text);
            TextNode node = new TextNode(text, BaseUri());
            PrependChild(node);
            return this;
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.Element Append(String html) {
            Validate.NotNull(html);
            IList<Node> nodes = iText.Html2pdf.Jsoup.Parser.Parser.ParseFragment(html, this, BaseUri());
        ...
        /// <returns>this element</returns>
        /// <seealso cref="Html(System.String)"/>
        public virtual iText.Html2pdf.Jsoup.Nodes.Element Prepend(String html) {
            Validate.NotNull(html);
            IList<Node> nodes = iText.Html2pdf.Jsoup.Parser.Parser.ParseFragment(html, this, BaseUri());
        ...
        public override Node After(String html) {
            return (iText.Html2pdf.Jsoup.Nodes.Element)base.After(html);
        }
        ...
        public override Node After(Node node) {
            return (iText.Html2pdf.Jsoup.Nodes.Element)base.After(node);
        }
        ...
        /// <returns>this element</returns>
        public virtual iText.Html2pdf.Jsoup.Nodes.Element Empty() {
            childNodes.Clear();
            return this;
        }
        ...
        public virtual String CssSelector() {
            ...
            String classes = iText.Html2pdf.Jsoup.Helper.StringUtil.Join(ClassNames(), ".");
            if (classes.Length > 0) {
            ...
            selector.Insert(0, " > ");
            if (((iText.Html2pdf.Jsoup.Nodes.Element)Parent()).Select(selector.ToString()).Count > 1) {
                selector.Append(MessageFormatUtil.Format(":nth-child({0})", ElementSiblingIndex() + 1));
            }
            return ((iText.Html2pdf.Jsoup.Nodes.Element)Parent()).CssSelector() + selector.ToString();
        }
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.Element NextElementSibling() {
            if (parentNode == null) {
                return null;
            }
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.Element PreviousElementSibling() {
            if (parentNode == null) {
                return null;
            }
            IList<iText.Html2pdf.Jsoup.Nodes.Element> siblings = ((iText.Html2pdf.Jsoup.Nodes.Element)Parent()).Children();
        ...
        private static int IndexInList<E>(iText.Html2pdf.Jsoup.Nodes.Element search, IList<E> elements)
            where E : iText.Html2pdf.Jsoup.Nodes.Element {
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.Element GetElementById(String id) {
        ...
        private sealed class _NodeVisitor_894 : NodeVisitor {
            ...
            public void Head(Node node, int depth) {
                if (node is TextNode) {
                    ...
                    iText.Html2pdf.Jsoup.Nodes.Element.AppendNormalisedText(accum, textNode);
                }
                else {
                    if (node is iText.Html2pdf.Jsoup.Nodes.Element) {
        ...
        private void OwnText(StringBuilder accum) {
            foreach (Node child in childNodes) {
                if (child is TextNode) {
                    ...
                    if (child is iText.Html2pdf.Jsoup.Nodes.Element) {
                        AppendWhitespaceIfBr((iText.Html2pdf.Jsoup.Nodes.Element)child, accum);
                    }
                }
            }
        }
        ...
        private static void AppendWhitespaceIfBr(iText.Html2pdf.Jsoup.Nodes.Element element, StringBuilder accum) {
        ...
        /// <returns>this element</returns>
        public virtual iText.Html2pdf.Jsoup.Nodes.Element Text(String text) {
            Validate.NotNull(text);
            Empty();
        ...
        public virtual bool HasText() {
            foreach (Node child in childNodes) {
                if (child is TextNode) {
                    ...
                    if (child is iText.Html2pdf.Jsoup.Nodes.Element) {
                        iText.Html2pdf.Jsoup.Nodes.Element el = (iText.Html2pdf.Jsoup.Nodes.Element)child;
                        if (el.HasText()) {
                            return true;
                        }
                    }
        ...
        public virtual String Data() {
            ...
            foreach (Node childNode in childNodes) {
                if (childNode is DataNode) {
                    ...
                    if (childNode is iText.Html2pdf.Jsoup.Nodes.Element) {
                        iText.Html2pdf.Jsoup.Nodes.Element element = (iText.Html2pdf.Jsoup.Nodes.Element)childNode;
        ...
        /// <returns>this element, for chaining</returns>
        public virtual iText.Html2pdf.Jsoup.Nodes.Element ClassNames(ICollection<String> classNames) {
            Validate.NotNull(classNames);
            attributes.Put("class", iText.Html2pdf.Jsoup.Helper.StringUtil.Join(classNames, " "));
            return this;
        }
        ...
        /// <returns>this element</returns>
        public virtual iText.Html2pdf.Jsoup.Nodes.Element AddClass(String className) {
        ...
        /// <returns>this element</returns>
        public virtual iText.Html2pdf.Jsoup.Nodes.Element RemoveClass(String className) {
            Validate.NotNull(className);
            ICollection<String> classes = ClassNames();
        ...
        /// <returns>this element</returns>
        public virtual iText.Html2pdf.Jsoup.Nodes.Element ToggleClass(String className) {
            Validate.NotNull(className);
            ICollection<String> classes = ClassNames();
        ...
        /// <returns>this element (for chaining)</returns>
        public virtual iText.Html2pdf.Jsoup.Nodes.Element Val(String value) {
            if (TagName().Equals("textarea")) {
                Text(value);
            }
            else {
        ...
        public virtual iText.Html2pdf.Jsoup.Nodes.Element Html(String html) {
            Empty();
            Append(html);
            return this;
        }
