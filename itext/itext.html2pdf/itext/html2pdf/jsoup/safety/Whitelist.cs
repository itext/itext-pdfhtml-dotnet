...
namespace iText.Html2pdf.Jsoup.Safety {
    ...
    public class Whitelist {
        ...
        */
        ...
        public static iText.Html2pdf.Jsoup.Safety.Whitelist None() {
            return new iText.Html2pdf.Jsoup.Safety.Whitelist();
        }
        ...
        /// </remarks>
        /// <returns>whitelist</returns>
        public static iText.Html2pdf.Jsoup.Safety.Whitelist SimpleText() {
            return new iText.Html2pdf.Jsoup.Safety.Whitelist().AddTags("b", "em", "i", "strong", "u");
        }
        ...
        /// </remarks>
        /// <returns>whitelist</returns>
        public static iText.Html2pdf.Jsoup.Safety.Whitelist Basic() {
            return new iText.Html2pdf.Jsoup.Safety.Whitelist().AddTags("a", "b", "blockquote", "br", "cite", "code", "dd"
                , "dl", "dt", "em", "i", "li", "ol", "p", "pre", "q", "small", "span", "strike", "strong", "sub", "sup"
                , "u", "ul").AddAttributes("a", "href").AddAttributes("blockquote", "cite").AddAttributes("q", "cite")
                .AddProtocols("a", "href", "ftp", "http", "https", "mailto").AddProtocols("blockquote", "cite", "http"
                , "https").AddProtocols("cite", "cite", "http", "https").AddEnforcedAttribute("a", "rel", "nofollow");
        }
        ...
        /// </summary>
        /// <returns>whitelist</returns>
        public static iText.Html2pdf.Jsoup.Safety.Whitelist BasicWithImages() {
        ...
        /// </remarks>
        /// <returns>whitelist</returns>
        public static iText.Html2pdf.Jsoup.Safety.Whitelist Relaxed() {
            return new iText.Html2pdf.Jsoup.Safety.Whitelist().AddTags("a", "b", "blockquote", "br", "caption", "cite"
                , "code", "col", "colgroup", "dd", "div", "dl", "dt", "em", "h1", "h2", "h3", "h4", "h5", "h6", "i", "img"
                , "li", "ol", "p", "pre", "q", "small", "span", "strike", "strong", "sub", "sup", "table", "tbody", "td"
                , "tfoot", "th", "thead", "tr", "u", "ul").AddAttributes("a", "href", "title").AddAttributes("blockquote"
        ...
        public virtual iText.Html2pdf.Jsoup.Safety.Whitelist AddTags(params String[] tags) {
        ...
        /// <returns>this (for chaining)</returns>
        public virtual iText.Html2pdf.Jsoup.Safety.Whitelist RemoveTags(params String[] tags) {
            Validate.NotNull(tags);
        ...
        /// <returns>this (for chaining)</returns>
        public virtual iText.Html2pdf.Jsoup.Safety.Whitelist AddAttributes(String tag, params String[] keys) {
            Validate.NotEmpty(tag);
        ...
        /// <returns>this (for chaining)</returns>
        public virtual iText.Html2pdf.Jsoup.Safety.Whitelist RemoveAttributes(String tag, params String[] keys) {
            Validate.NotEmpty(tag);
            Validate.NotNull(keys);
            Validate.IsTrue(keys.Length > 0, "No attributes supplied.");
            Whitelist.TagName tagName = Whitelist.TagName.ValueOf(tag);
        ...
        /// <returns>this (for chaining)</returns>
        public virtual iText.Html2pdf.Jsoup.Safety.Whitelist AddEnforcedAttribute(String tag, String key, String value
            ) {
            Validate.NotEmpty(tag);
            Validate.NotEmpty(key);
        ...
        /// <param name="key">The attribute key</param>
        /// <returns>this (for chaining)</returns>
        public virtual iText.Html2pdf.Jsoup.Safety.Whitelist RemoveEnforcedAttribute(String tag, String key) {
            Validate.NotEmpty(tag);
            Validate.NotEmpty(key);
            Whitelist.TagName tagName = Whitelist.TagName.ValueOf(tag);
        ...
        public virtual iText.Html2pdf.Jsoup.Safety.Whitelist PreserveRelativeLinks(bool preserve) {
        ...
        /// <returns>this, for chaining</returns>
        public virtual iText.Html2pdf.Jsoup.Safety.Whitelist AddProtocols(String tag, String key, params String[] 
            protocols) {
            Validate.NotEmpty(tag);
            Validate.NotEmpty(key);
        ...
        /// <returns>this, for chaining</returns>
        public virtual iText.Html2pdf.Jsoup.Safety.Whitelist RemoveProtocols(String tag, String key, params String
            [] protocols) {
            Validate.NotEmpty(tag);
            Validate.NotEmpty(key);
            Validate.NotNull(protocols);
        ...
        /// <returns>true if allowed</returns>
        protected internal virtual bool IsSafeAttribute(String tagName, iText.Html2pdf.Jsoup.Nodes.Element el, iText.Html2pdf.Jsoup.Nodes.Attribute
             attr) {
        ...
        private bool TestValidProtocol(iText.Html2pdf.Jsoup.Nodes.Element el, iText.Html2pdf.Jsoup.Nodes.Attribute
