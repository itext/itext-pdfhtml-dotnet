...
namespace iText.Html2pdf.Jsoup.Safety {
    ...
    /// <c>clean</c>
    /// methods in
    /// <see cref="iText.Html2pdf.Jsoup.Jsoup"/>
    /// .
    /// </p>
    /// </remarks>
    public class Cleaner {
        ...
        /// using the
        /// <see cref="Clean(iText.Html2pdf.Jsoup.Nodes.Document)"/>
        ...
        private sealed class CleaningVisitor : NodeVisitor {
            ...
            internal readonly iText.Html2pdf.Jsoup.Nodes.Element root;

            internal iText.Html2pdf.Jsoup.Nodes.Element destination;

            internal CleaningVisitor(Cleaner _enclosing, iText.Html2pdf.Jsoup.Nodes.Element root, iText.Html2pdf.Jsoup.Nodes.Element
                 destination) {
            ...
            public void Head(Node source, int depth) {
                if (source is iText.Html2pdf.Jsoup.Nodes.Element) {
                    iText.Html2pdf.Jsoup.Nodes.Element sourceEl = (iText.Html2pdf.Jsoup.Nodes.Element)source;
                    if (this._enclosing.whitelist.IsSafeTag(sourceEl.TagName())) {
                        ...
                        iText.Html2pdf.Jsoup.Nodes.Element destChild = meta.el;
        ...
        private int CopySafeNodes(iText.Html2pdf.Jsoup.Nodes.Element source, iText.Html2pdf.Jsoup.Nodes.Element dest
            ) {
        ...
        private Cleaner.ElementMeta CreateSafeElement(iText.Html2pdf.Jsoup.Nodes.Element sourceEl) {
            String sourceTag = sourceEl.TagName();
            Attributes destAttrs = new Attributes();
            iText.Html2pdf.Jsoup.Nodes.Element dest = new iText.Html2pdf.Jsoup.Nodes.Element(iText.Html2pdf.Jsoup.Parser.Tag
                .ValueOf(sourceTag), sourceEl.BaseUri(), destAttrs);
            int numDiscarded = 0;
            Attributes sourceAttrs = sourceEl.Attributes();
            foreach (iText.Html2pdf.Jsoup.Nodes.Attribute sourceAttr in sourceAttrs) {
        ...
        private class ElementMeta {
            internal iText.Html2pdf.Jsoup.Nodes.Element el;

            internal int numAttribsDiscarded;

            internal ElementMeta(iText.Html2pdf.Jsoup.Nodes.Element el, int numAttribsDiscarded) {
                this.el = el;
