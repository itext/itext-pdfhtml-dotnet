...
namespace iText.Html2pdf.Jsoup.Select {
    ...
    public class Collector {
        ...
        public static Elements Collect(Evaluator eval, iText.Html2pdf.Jsoup.Nodes.Element root) {
        ...
        private class Accumulator : NodeVisitor {
            ...
            internal Accumulator(iText.Html2pdf.Jsoup.Nodes.Element root, Elements elements, Evaluator eval) {
                this.root = root;
            ...
            public virtual void Head(Node node, int depth) {
                if (node is iText.Html2pdf.Jsoup.Nodes.Element) {
                    iText.Html2pdf.Jsoup.Nodes.Element el = (iText.Html2pdf.Jsoup.Nodes.Element)node;
