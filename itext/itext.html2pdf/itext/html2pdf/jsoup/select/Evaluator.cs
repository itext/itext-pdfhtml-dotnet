...
namespace iText.Html2pdf.Jsoup.Select {
    ...
    public abstract class Evaluator {
        ...
        /// </returns>
        public abstract bool Matches(iText.Html2pdf.Jsoup.Nodes.Element root, iText.Html2pdf.Jsoup.Nodes.Element element
            );
        ...
        public sealed class AttributeStarting : Evaluator {
            ...
            public override bool Matches(iText.Html2pdf.Jsoup.Nodes.Element root, iText.Html2pdf.Jsoup.Nodes.Element element
                ...
                IList<iText.Html2pdf.Jsoup.Nodes.Attribute> values = element.Attributes().AsList();
                foreach (iText.Html2pdf.Jsoup.Nodes.Attribute attribute in values) {
        ...
        public abstract class CssNthEvaluator : Evaluator {
            ...
            protected internal abstract int CalculatePosition(iText.Html2pdf.Jsoup.Nodes.Element root, iText.Html2pdf.Jsoup.Nodes.Element
                 element);
        }
        ...
        public sealed class IsNthChild : Evaluator.CssNthEvaluator {
            ...
            protected internal override int CalculatePosition(iText.Html2pdf.Jsoup.Nodes.Element root, iText.Html2pdf.Jsoup.Nodes.Element
                 element) {
        ...
        public sealed class IsNthLastChild : Evaluator.CssNthEvaluator {
            ...
            protected internal override int CalculatePosition(iText.Html2pdf.Jsoup.Nodes.Element root, iText.Html2pdf.Jsoup.Nodes.Element
                 element) {
                return ((iText.Html2pdf.Jsoup.Nodes.Element)element.Parent()).Children().Count - element.ElementSiblingIndex
                    ();
            }
        ...
        public class IsNthOfType : Evaluator.CssNthEvaluator {
            ...
            protected internal override int CalculatePosition(iText.Html2pdf.Jsoup.Nodes.Element root, iText.Html2pdf.Jsoup.Nodes.Element
                 element) {
                int pos = 0;
                Elements family = ((iText.Html2pdf.Jsoup.Nodes.Element)element.Parent()).Children();
                foreach (iText.Html2pdf.Jsoup.Nodes.Element el in family) {
        ...
        public sealed class IsRoot : Evaluator {
            public override bool Matches(iText.Html2pdf.Jsoup.Nodes.Element root, iText.Html2pdf.Jsoup.Nodes.Element element
                ...
                iText.Html2pdf.Jsoup.Nodes.Element r = root is Document ? root.Child(0) : root;
                return element == r;
            }
