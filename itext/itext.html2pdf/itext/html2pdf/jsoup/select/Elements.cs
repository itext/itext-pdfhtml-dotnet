...
namespace iText.Html2pdf.Jsoup.Select {
    /// <summary>
    /// A list of
    /// <see cref="iText.Html2pdf.Jsoup.Nodes.Element"/>
    /// s, with methods that act on every element in the list.
    /// <p>
    /// To get an
    /// <c>Elements</c>
    /// object, use the
    /// <see cref="iText.Html2pdf.Jsoup.Nodes.Element.Select(System.String)"/>
    /// method.
    /// </p>
    /// </summary>
    ...
    public class Elements : List<Element> {
        ...
        public Object Clone() {
            iText.Html2pdf.Jsoup.Select.Elements clone = new iText.Html2pdf.Jsoup.Select.Elements(Count);
        ...
        public virtual iText.Html2pdf.Jsoup.Select.Elements Attr(String attributeKey, String attributeValue) {
            foreach (Element element in this) {
        ...
        public virtual iText.Html2pdf.Jsoup.Select.Elements RemoveAttr(String attributeKey) {
            foreach (Element element in this) {
        ...
        /// <returns>this</returns>
        public virtual iText.Html2pdf.Jsoup.Select.Elements AddClass(String className) {
            foreach (Element element in this) {
        ...
        /// <returns>this</returns>
        public virtual iText.Html2pdf.Jsoup.Select.Elements RemoveClass(String className) {
            foreach (Element element in this) {
        ...
        /// <returns>this</returns>
        public virtual iText.Html2pdf.Jsoup.Select.Elements ToggleClass(String className) {
            foreach (Element element in this) {
        ...
        /// <seealso cref="iText.Html2pdf.Jsoup.Nodes.Element.Val()"/>
        ...
        /// <returns>this (for chaining)</returns>
        public virtual iText.Html2pdf.Jsoup.Select.Elements Val(String value) {
            foreach (Element element in this) {
                element.Val(value);
            }
            return this;
        ...
        /// <seealso cref="iText.Html2pdf.Jsoup.Nodes.Element.Text()"/>
        ...
        /// <returns>this, for chaining</returns>
        /// <seealso cref="iText.Html2pdf.Jsoup.Nodes.Element.TagName(System.String)"/>
        public virtual iText.Html2pdf.Jsoup.Select.Elements TagName(String tagName) {
            foreach (Element element in this) {
        ...
        /// <returns>this, for chaining</returns>
        /// <seealso cref="iText.Html2pdf.Jsoup.Nodes.Element.Html(System.String)"/>
        public virtual iText.Html2pdf.Jsoup.Select.Elements Html(String html) {
            foreach (Element element in this) {
                element.Html(html);
            }
            return this;
        ...
        /// <returns>this, for chaining</returns>
        /// <seealso cref="iText.Html2pdf.Jsoup.Nodes.Element.Prepend(System.String)"/>
        public virtual iText.Html2pdf.Jsoup.Select.Elements Prepend(String html) {
            foreach (Element element in this) {
        ...
        /// <returns>this, for chaining</returns>
        /// <seealso cref="iText.Html2pdf.Jsoup.Nodes.Element.Append(System.String)"/>
        public virtual iText.Html2pdf.Jsoup.Select.Elements Append(String html) {
            foreach (Element element in this) {
                element.Append(html);
            }
            return this;
        ...
        /// <returns>this, for chaining</returns>
        /// <seealso cref="iText.Html2pdf.Jsoup.Nodes.Element.Before(System.String)"/>
        public virtual iText.Html2pdf.Jsoup.Select.Elements Before(String html) {
            foreach (Element element in this) {
                element.Before(html);
            }
            return this;
        ...
        /// <returns>this, for chaining</returns>
        /// <seealso cref="iText.Html2pdf.Jsoup.Nodes.Element.After(System.String)"/>
        public virtual iText.Html2pdf.Jsoup.Select.Elements After(String html) {
            foreach (Element element in this) {
                element.After(html);
            }
            return this;
        ...
        /// </param>
        /// <returns>this (for chaining)</returns>
        /// <seealso cref="iText.Html2pdf.Jsoup.Nodes.Element.Wrap(System.String)"/>
        public virtual iText.Html2pdf.Jsoup.Select.Elements Wrap(String html) {
        ...
        /// </remarks>
        /// <returns>this (for chaining)</returns>
        /// <seealso cref="iText.Html2pdf.Jsoup.Nodes.Node.Unwrap()"/>
        public virtual iText.Html2pdf.Jsoup.Select.Elements Unwrap() {
            foreach (Element element in this) {
                element.Unwrap();
            }
            return this;
        ...
        /// </remarks>
        /// <returns>this, for chaining</returns>
        /// <seealso cref="iText.Html2pdf.Jsoup.Nodes.Element.Empty()"/>
        /// <seealso cref="Remove()"/>
        public virtual iText.Html2pdf.Jsoup.Select.Elements Empty() {
            foreach (Element element in this) {
                element.Empty();
            }
            return this;
        ...
        /// <see cref="iText.Html2pdf.Jsoup.Safety.Cleaner"/>
        /// to clean HTML.
        /// </remarks>
        /// <returns>this, for chaining</returns>
        /// <seealso cref="iText.Html2pdf.Jsoup.Nodes.Element.Empty()"/>
        /// <seealso cref="Empty()"/>
        public virtual iText.Html2pdf.Jsoup.Select.Elements Remove() {
            foreach (Element element in this) {
                element.Remove();
            }
            return this;
        ...
        public virtual iText.Html2pdf.Jsoup.Select.Elements Select(String query) {
        ...
        public virtual iText.Html2pdf.Jsoup.Select.Elements Not(String query) {
            iText.Html2pdf.Jsoup.Select.Elements @out = Selector.Select(query, this);
        ...
        ///     </returns>
        public virtual iText.Html2pdf.Jsoup.Select.Elements Eq(int index) {
            return Count > index ? new iText.Html2pdf.Jsoup.Select.Elements(this[index]) : new iText.Html2pdf.Jsoup.Select.Elements();
        }
        ...
        public virtual bool Is(String query) {
            iText.Html2pdf.Jsoup.Select.Elements children = Select(query);
        ...
        public virtual iText.Html2pdf.Jsoup.Select.Elements Parents() {
            ICollection<Element> combo = new LinkedHashSet<Element>();
            foreach (Element e in this) {
                combo.AddAll(e.Parents());
            }
            return new iText.Html2pdf.Jsoup.Select.Elements(combo);
        }
        ...
        /// <returns>this, for chaining</returns>
        public virtual iText.Html2pdf.Jsoup.Select.Elements Traverse(NodeVisitor nodeVisitor) {
        ...
        /// <summary>
        /// Get the
        /// <see cref="iText.Html2pdf.Jsoup.Nodes.FormElement"/>
