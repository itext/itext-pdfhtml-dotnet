...
namespace iText.Html2pdf.Css {
    ...
    public class AbsolutePositionFlexGridTest : ExtendedHtmlConversionITextTest {
        public static readonly String SOURCE_FOLDER = iText.Test.TestUtil.GetParentProjectDirectory(NUnit.Framework.TestContext
            .CurrentContext.TestDirectory) + "/resources/itext/html2pdf/css/AbsolutePositionFlexGridTest/";

        public static readonly String DESTINATION_FOLDER = NUnit.Framework.TestContext.CurrentContext.TestDirectory
             + "/test/itext/html2pdf/css/AbsolutePositionFlexGridTest/";
        ...
        public virtual void AbsPosInFlexContainerTest() {
        ...
        public virtual void AbsPosInGridContainerTest() {
            ConvertToPdfAndCompare("absPosInGridContainer", SOURCE_FOLDER, DESTINATION_FOLDER);
        }

        [NUnit.Framework.Test]
        public virtual void AbsPosFlexJustifyAlignTest() {
