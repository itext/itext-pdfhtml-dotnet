...
namespace iText.Html2pdf.Css.W3c {
    ...
    public abstract class W3CCssAhemFontTest : W3CCssTest {
        private static readonly String AHEM_FONT_PATH = iText.Test.TestUtil.GetParentProjectDirectory(NUnit.Framework.TestContext
            .CurrentContext.TestDirectory) + "/resources/itext/html2pdf/css/w3c/AhemFont/Ahem.ttf";
