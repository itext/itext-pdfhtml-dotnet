...
namespace iText.Html2pdf.Jsoup.Select {
    ...
    public class ElementsTest {
        ...
        public virtual void HasAttr() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p title=foo><p title=bar><p class=foo><p class=bar>");
        ...
        public virtual void Classes() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p class='mellow yellow'></p><p class='red green'></p>"
                );
        ...
        public virtual void HasText() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p>Hello</p></div><div><p></p></div>");
        ...
        public virtual void Html() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p>Hello</p></div><div><p>There</p></div>");
            Elements divs = doc.Select("div");
        ...
        public virtual void SetHtml() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p>One</p><p>Two</p><p>Three</p>");
            Elements ps = doc.Select("p");
        ...
        public virtual void Val() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<input value='one' /><textarea>two</textarea>");
        ...
        public virtual void Before() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p>This <a>is</a> <a>jsoup</a>.</p>");
        ...
        public virtual void Empty() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p>Hello <b>there</b></p> <p>now!</p></div>");
        ...
        public virtual void Remove() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p>Hello <b>there</b></p> jsoup <p>now!</p></div>");
            doc.OutputSettings().PrettyPrint(false);
            doc.Select("p").Remove();
        ...
        public virtual void Parents() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p>Hello</p></div><p>There</p>");
        ...
        public virtual void Not() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div id=1><p>One</p></div> <div id=2><p><span>Two</span></p></div>"
                );
        ...
        public virtual void TagNameSet() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p>Hello <i>there</i> <i>now</i></p>");
        ...
        public virtual void Traverse() {
            ...
            doc.Select("div").Traverse(new _NodeVisitor_301(accum));
            NUnit.Framework.Assert.AreEqual("<div><p><#text></#text></p></div><div><#text></#text></div>", accum.ToString
                ());
        }

        private sealed class _NodeVisitor_301 : NodeVisitor {
            public _NodeVisitor_301(StringBuilder accum) {
                this.accum = accum;
            }
        ...
        public virtual void Forms() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<form id=1><input name=q></form><div /><form id=2><input name=f></form>"
                );
        ...
        public virtual void ClassWithHyphen() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p class='tab-nav'>Check</p>");
