...
namespace iText.Html2pdf.Jsoup.Select {
    ...
    public class SelectorTest {
        ...
        public virtual void TestByTag() {
            Elements els = iText.Html2pdf.Jsoup.Jsoup.Parse("<div id=1><div id=2><p>Hello</p></div></div><div id=3>").
                Select("div");
            ...
            Elements none = iText.Html2pdf.Jsoup.Jsoup.Parse("<div id=1><div id=2><p>Hello</p></div></div><div id=3>")
                .Select("span");
        ...
        public virtual void TestById() {
            Elements els = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p id=foo>Hello</p><p id=foo>Foo two!</p></div>").Select
                ("#foo");
            ...
            Elements none = iText.Html2pdf.Jsoup.Jsoup.Parse("<div id=1></div>").Select("#foo");
            NUnit.Framework.Assert.AreEqual(0, none.Count);
        }

        [NUnit.Framework.Test]
        public virtual void TestByClass() {
            Elements els = iText.Html2pdf.Jsoup.Jsoup.Parse("<p id=0 class='one two'><p id=1 class='one'><p id=2 class='two'>"
                ).Select("p.one");
            NUnit.Framework.Assert.AreEqual(2, els.Count);
            NUnit.Framework.Assert.AreEqual("0", els[0].Id());
            NUnit.Framework.Assert.AreEqual("1", els[1].Id());
            Elements none = iText.Html2pdf.Jsoup.Jsoup.Parse("<div class='one'></div>").Select(".foo");
            NUnit.Framework.Assert.AreEqual(0, none.Count);
            Elements els2 = iText.Html2pdf.Jsoup.Jsoup.Parse("<div class='One-Two'></div>").Select(".one-two");
        ...
        public virtual void TestNamespacedTag() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><abc:def id=1>Hello</abc:def></div> <abc:def class=bold id=2>There</abc:def>"
                );
        ...
        public virtual void TestByAttributeStarting() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div id=1 data-name=jsoup>Hello</div><p data-val=5 id=2>There</p><p id=3>No</p>"
                );
        ...
        public virtual void TestByAttributeRegex() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p><img src=foo.png id=1><img src=bar.jpg id=2><img src=qux.JPEG id=3><img src=old.gif><img></p>"
                );
        ...
        public virtual void TestByAttributeRegexCharacterClass() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p><img src=foo.png id=1><img src=bar.jpg id=2><img src=qux.JPEG id=3><img src=old.gif id=4></p>"
                );
        ...
        public virtual void TestByAttributeRegexCombined() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><table class=x><td>Hello</td></table></div>");
        ...
        public virtual void TestCombinedWithContains() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p id=1>One</p><p>Two +</p><p>Three +</p>");
        ...
        public virtual void TestGroupOrAttribute() {
            ...
            Elements els = iText.Html2pdf.Jsoup.Jsoup.Parse(h).Select("[id],[title=foo]");
            NUnit.Framework.Assert.AreEqual(3, els.Count);
            NUnit.Framework.Assert.AreEqual("1", els[0].Id());
            NUnit.Framework.Assert.AreEqual("2", els[1].Id());
        ...
        public virtual void Descendant() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(h);
            iText.Html2pdf.Jsoup.Nodes.Element root = doc.GetElementsByClass("head").First();
        ...
        public virtual void TestCharactersInIdAndClass() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(h);
            iText.Html2pdf.Jsoup.Nodes.Element el1 = doc.GetElementById("a1-foo_bar");
            NUnit.Framework.Assert.AreEqual("One", el1.Text());
            iText.Html2pdf.Jsoup.Nodes.Element el2 = doc.GetElementsByClass("b2-qux_bif").First();
            NUnit.Framework.Assert.AreEqual("Two", el2.Text());
            iText.Html2pdf.Jsoup.Nodes.Element el3 = doc.Select("#a1-foo_bar").First();
            NUnit.Framework.Assert.AreEqual("One", el3.Text());
            iText.Html2pdf.Jsoup.Nodes.Element el4 = doc.Select(".b2-qux_bif").First();
        ...
        public virtual void TestSupportsLeadingCombinator() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(h);
            iText.Html2pdf.Jsoup.Nodes.Element p = doc.Select("div > p").First();
            Elements spans = p.Select("> span");
            NUnit.Framework.Assert.AreEqual(2, spans.Count);
            NUnit.Framework.Assert.AreEqual("One", spans.First().Text());
            // make sure doesn't get nested
            h = "<div id=1><div id=2><div id=3></div></div></div>";
            doc = iText.Html2pdf.Jsoup.Jsoup.Parse(h);
            iText.Html2pdf.Jsoup.Nodes.Element div = doc.Select("div").Select(" > div").First();
            NUnit.Framework.Assert.AreEqual("2", div.Id());
        }

        [NUnit.Framework.Test]
        public virtual void TestPseudoLessThan() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p>One</p><p>Two</p><p>Three</>p></div><div><p>Four</p>"
                );
        ...
        public virtual void TestPseudoCombined() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div class='foo'><p>One</p><p>Two</p></div><div><p>Three</p><p>Four</p></div>"
                );
        ...
        public virtual void TestPseudoHas() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div id=0><p><span>Hello</span></p></div> <div id=1><span class=foo>There</span></div> <div id=2><p>Not</p></div>"
                );
        ...
        public virtual void TestNestedHas() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p><span>One</span></p></div> <div><p>Two</p></div>"
                );
        ...
        public virtual void TestPseudoContains() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p>The Rain.</p> <p class=light>The <i>rain</i>.</p> <p>Rain, the.</p></div>"
                );
        ...
        public virtual void TestPsuedoContainsWithParentheses() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p id=1>This (is good)</p><p id=2>This is bad)</p>");
        ...
        public virtual void ContainsOwn() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p id=1>Hello <b>there</b> now</p>");
        ...
        public virtual void TestMatches() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p id=1>The <i>Rain</i></p> <p id=2>There are 99 bottles.</p> <p id=3>Harder (this)</p> <p id=4>Rain</p>"
                );
        ...
        public virtual void TestRelaxedTags() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<abc_def id=1>Hello</abc_def> <abc-def id=2>There</abc-def>"
                );
        ...
        public virtual void NotParas() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p id=1>One</p> <p>Two</p> <p><span>Three</span></p>");
        ...
        public virtual void NotAll() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p>Two</p> <p><span>Three</span></p>");
        ...
        public virtual void NotClass() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div class=left>One</div><div class=right id=1><p>Two</p></div>"
                );
        ...
        public virtual void HandlesCommasInSelector() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p name='1,2'>One</p><div>Two</div><ol><li>123</li><li>Text</li></ol>"
                );
        ...
        public virtual void SelectSupplementaryCharacter() {
            String s = new String(iText.Html2pdf.Jsoup.PortUtil.ToChars(135361));
