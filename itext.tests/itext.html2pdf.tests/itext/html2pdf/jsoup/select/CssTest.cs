...
namespace iText.Html2pdf.Jsoup.Select {
    public class CssTest {
        ...
        public virtual void Init() {
            html = iText.Html2pdf.Jsoup.Jsoup.Parse(htmlString);
        }
        ...
        protected internal virtual void Check(Elements result, params String[] expectedContent) {
            NUnit.Framework.Assert.AreEqual(expectedContent.Length, result.Count, "Number of elements");
            for (int i = 0; i < expectedContent.Length; i++) {
                NUnit.Framework.Assert.IsNotNull(result[i]);
                NUnit.Framework.Assert.AreEqual(expectedContent[i], result[i].OwnText(), "Expected element");
            }
        }
        ...
        public virtual void Root() {
            ...
            NUnit.Framework.Assert.AreEqual(iText.Html2pdf.Jsoup.Parser.Tag.ValueOf("html"), sel[0].Tag());
            ...
            NUnit.Framework.Assert.AreEqual(iText.Html2pdf.Jsoup.Parser.Tag.ValueOf("body"), sel2[0].Tag());
        }
    }
}
