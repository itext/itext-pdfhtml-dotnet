...
namespace iText.Html2pdf.Jsoup.Integration {
    ...
    public class ParseTest {
        ...
        public virtual void TestNewsHomepage() {
            ...
            NUnit.Framework.Assert.AreEqual("Brace yourself for Metro meltdown", doc.Select(".id1225817868581 h4").Text
                ().Trim());
            iText.Html2pdf.Jsoup.Nodes.Element a = doc.Select("a[href=/entertainment/horoscopes]").First();
            ...
            iText.Html2pdf.Jsoup.Nodes.Element hs = doc.Select("a[href*=naughty-corners-are-a-bad-idea]").First();
        ...
        public virtual void TestYahooJp() {
            ...
            iText.Html2pdf.Jsoup.Nodes.Element a = doc.Select("a[href=t/2322m2]").First();
        ...
        public virtual void TestBaidu() {
            ...
            iText.Html2pdf.Jsoup.Nodes.Element newsLink = doc.Select("a:contains(新)").First();
