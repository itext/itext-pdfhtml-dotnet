...
namespace iText.Html2pdf.Jsoup.Parser {
    ...
    public class TagTest {
        ...
        public virtual void IsCaseInsensitive() {
            iText.Html2pdf.Jsoup.Parser.Tag p1 = iText.Html2pdf.Jsoup.Parser.Tag.ValueOf("P");
            iText.Html2pdf.Jsoup.Parser.Tag p2 = iText.Html2pdf.Jsoup.Parser.Tag.ValueOf("p");
        ...
        public virtual void DivSemantics() {
            iText.Html2pdf.Jsoup.Parser.Tag div = iText.Html2pdf.Jsoup.Parser.Tag.ValueOf("div");
        ...
        public virtual void PSemantics() {
            iText.Html2pdf.Jsoup.Parser.Tag p = iText.Html2pdf.Jsoup.Parser.Tag.ValueOf("p");
        ...
        public virtual void ImgSemantics() {
            iText.Html2pdf.Jsoup.Parser.Tag img = iText.Html2pdf.Jsoup.Parser.Tag.ValueOf("img");
        ...
        public virtual void DefaultSemantics() {
            iText.Html2pdf.Jsoup.Parser.Tag foo = iText.Html2pdf.Jsoup.Parser.Tag.ValueOf("foo");
            // not defined
            iText.Html2pdf.Jsoup.Parser.Tag foo2 = iText.Html2pdf.Jsoup.Parser.Tag.ValueOf("FOO");
