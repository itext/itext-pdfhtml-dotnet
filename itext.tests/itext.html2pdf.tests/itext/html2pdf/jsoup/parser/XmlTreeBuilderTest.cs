...
namespace iText.Html2pdf.Jsoup.Parser {
    ...
    public class XmlTreeBuilderTest {
        ...
        public virtual void TestSupplyParserToJsoupClass() {
            String xml = "<doc><val>One<val>Two</val></bar>Three</doc>";
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(xml, "http://foo.com/", iText.Html2pdf.Jsoup.Parser.Parser
                .XmlParser());
            NUnit.Framework.Assert.AreEqual("<doc><val>One<val>Two</val>Three</val></doc>", TextUtil.StripNewlines(doc
                .Html()));
        }
        ...
        public virtual void TestDoesNotForceSelfClosingKnownTags() {
            ...
            Document htmlDoc = iText.Html2pdf.Jsoup.Jsoup.Parse("<br>one</br>");
            NUnit.Framework.Assert.AreEqual("<br>one\n<br>", htmlDoc.Body().Html());
            Document xmlDoc = iText.Html2pdf.Jsoup.Jsoup.Parse("<br>one</br>", "", iText.Html2pdf.Jsoup.Parser.Parser.
                XmlParser());
        ...
        public virtual void HandlesXmlDeclarationAsDeclaration() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(html, "", iText.Html2pdf.Jsoup.Parser.Parser.XmlParser());
            NUnit.Framework.Assert.AreEqual("<?xml encoding=\"UTF-8\"?> <body> One </body> <!-- comment -->", iText.Html2pdf.Jsoup.Helper.StringUtil
        ...
        public virtual void XmlFragment() {
            ...
            IList<Node> nodes = iText.Html2pdf.Jsoup.Parser.Parser.ParseXmlFragment(xml, "http://example.com/");
        ...
        public virtual void XmlParseDefaultsToHtmlOutputSyntax() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("x", "", iText.Html2pdf.Jsoup.Parser.Parser.XmlParser());
        ...
        public virtual void TestDoesHandleEOFInTag() {
            ...
            Document xmlDoc = iText.Html2pdf.Jsoup.Jsoup.Parse(html, "", iText.Html2pdf.Jsoup.Parser.Parser.XmlParser(
                ));
        ...
        public virtual void TestParseDeclarationAttributes() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(xml, "", iText.Html2pdf.Jsoup.Parser.Parser.XmlParser());
