...
namespace iText.Html2pdf.Jsoup.Parser {
    ...
    public class AttributeParseTest {
        ...
        public virtual void ParsesRoughAttributeString() {
            ...
            iText.Html2pdf.Jsoup.Nodes.Element el = iText.Html2pdf.Jsoup.Jsoup.Parse(html).GetElementsByTag("a")[0];
        ...
        public virtual void HandlesNewLinesAndReturns() {
            String html = "<a\r\nfoo='bar\r\nqux'\r\nbar\r\n=\r\ntwo>One</a>";
            iText.Html2pdf.Jsoup.Nodes.Element el = iText.Html2pdf.Jsoup.Jsoup.Parse(html).Select("a").First();
        ...
        public virtual void StrictAttributeUnescapes() {
            ...
            Elements els = iText.Html2pdf.Jsoup.Jsoup.Parse(html).Select("a");
        ...
        public virtual void ParsesBooleanAttributes() {
            ...
            IList<iText.Html2pdf.Jsoup.Nodes.Attribute> attributes = el.Attributes().AsList();
