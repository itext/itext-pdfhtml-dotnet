...
namespace iText.Html2pdf.Jsoup.Parser {
    ...
    public class HtmlParserTest {
        ...
        public virtual void ParsesSimpleDocument() {
            ...
            iText.Html2pdf.Jsoup.Nodes.Element p = doc.Body().Child(0);
            NUnit.Framework.Assert.AreEqual("p", p.TagName());
            iText.Html2pdf.Jsoup.Nodes.Element img = p.Child(0);
        ...
        public virtual void ParsesQuiteRoughAttributes() {
            ...
            doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p .....>");
        ...
        public virtual void ParsesComments() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(html);
            iText.Html2pdf.Jsoup.Nodes.Element body = doc.Body();
            ...
            iText.Html2pdf.Jsoup.Nodes.Element p = body.Child(1);
        ...
        public virtual void ParsesUnterminatedComments() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(html);
            iText.Html2pdf.Jsoup.Nodes.Element p = doc.GetElementsByTag("p")[0];
        ...
        public virtual void DropsUnterminatedTag() {
            ...
            String h1 = "<p";
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(h1);
            ...
            doc = iText.Html2pdf.Jsoup.Jsoup.Parse(h2);
            NUnit.Framework.Assert.AreEqual("", doc.Text());
        }
        ...
        public virtual void ParsesUnterminatedTextarea() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<body><p><textarea>one<p>two");
            iText.Html2pdf.Jsoup.Nodes.Element t = doc.Select("textarea").First();
        ...
        public virtual void ParsesUnterminatedOption() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<body><p><select><option>One<option>Two</p><p>Three</p>");
        ...
        public virtual void TestSpaceAfterTag() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div > <a name=\"top\"></a ><p id=1 >Hello</p></div>");
        ...
        public virtual void CreatesDocumentStructure() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(html);
            iText.Html2pdf.Jsoup.Nodes.Element head = doc.Head();
            iText.Html2pdf.Jsoup.Nodes.Element body = doc.Body();
        ...
        public virtual void HandlesEscapedData() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(html);
            iText.Html2pdf.Jsoup.Nodes.Element div = doc.GetElementsByTag("div")[0];
        ...
        public virtual void HandlesDataOnlyTags() {
            ...
            IList<iText.Html2pdf.Jsoup.Nodes.Element> tels = iText.Html2pdf.Jsoup.Jsoup.Parse(t).GetElementsByTag("style"
                );
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(s);
        ...
        public virtual void HandlesTextArea() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<textarea>Hello</textarea>");
        ...
        public virtual void PreservesSpaceInTextArea() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<textarea>\n\tOne\n\tTwo\n\tThree\n</textarea>");
            String expect = "One\n\tTwo\n\tThree";
            // the leading and trailing spaces are dropped as a convenience to authors
            iText.Html2pdf.Jsoup.Nodes.Element el = doc.Select("textarea").First();
        ...
        public virtual void PreservesSpaceInScript() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<script>\nOne\n\tTwo\n\tThree\n</script>");
            String expect = "\nOne\n\tTwo\n\tThree\n";
            iText.Html2pdf.Jsoup.Nodes.Element el = doc.Select("script").First();
        ...
        public virtual void DoesNotCreateImplicitLists() {
            ...
            NUnit.Framework.Assert.AreEqual("body", ((iText.Html2pdf.Jsoup.Nodes.Element)lis.First().Parent()).TagName
                ());
            // no fiddling with non-implicit lists
            String h2 = "<ol><li><p>Point the first<li><p>Point the second";
            Document doc2 = iText.Html2pdf.Jsoup.Jsoup.Parse(h2);
        ...
        public virtual void HandlesNestedImplicitTable() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<table><td>1</td></tr> <td>2</td></tr> <td> <table><td>3</td> <td>4</td></table> <tr><td>5</table>"
                );
        ...
        public virtual void HandlesTbodyTable() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<html><head></head><body><table><tbody><tr><td>aaa</td><td>bbb</td></tr></tbody></table></body></html>"
                );
        ...
        public virtual void HandlesImplicitCaptionClose() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<table><caption>A caption<td>One<td>Two");
        ...
        public virtual void NoTableDirectInTable() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<table> <td>One <td><table><td>Two</table> <table><td>Three"
                );
        ...
        public virtual void IgnoresDupeEndTrTag() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<table><tr><td>One</td><td><table><tr><td>Two</td></tr></tr></table></td><td>Three</td></tr></table>"
                );
        ...
        public virtual void HandlesBaseTags() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(h, "http://foo/");
        ...
        public virtual void HandlesProtocolRelativeUrl() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(html, @base);
            iText.Html2pdf.Jsoup.Nodes.Element el = doc.Select("img").First();
        ...
        public virtual void HandlesUnknownInlineTags() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.ParseBodyFragment(h);
        ...
        public virtual void ParsesBodyFragment() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.ParseBodyFragment(h, "http://example.com");
        ...
        public virtual void HandlesBlocksInDefinitions() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(h);
            NUnit.Framework.Assert.AreEqual("dt", ((iText.Html2pdf.Jsoup.Nodes.Element)doc.Select("#1").First().Parent
                ()).TagName());
            NUnit.Framework.Assert.AreEqual("dd", ((iText.Html2pdf.Jsoup.Nodes.Element)doc.Select("#2").First().Parent
                ()).TagName());
        ...
        public virtual void HandlesBaseWithoutHref() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(h, "http://example.com/");
            iText.Html2pdf.Jsoup.Nodes.Element a = doc.Select("a").First();
        ...
        public virtual void NormalisesHeadlessBody() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<html><body><span class=\"foo\">bar</span>");
        ...
        public virtual void NormalisedBodyAfterContent() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<font face=Arial><body class=name><div>One</div></body></font>"
                );
        ...
        public virtual void TestHgroup() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<h1>Hello <h2>There <hgroup><h1>Another<h2>headline</hgroup> <hgroup><h1>More</h1><p>stuff</p></hgroup>"
                );
        ...
        public virtual void TestRelaxedTags() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<abc_def id=1>Hello</abc_def> <abc-def>There</abc-def>");
        ...
        public virtual void TestHeaderContents() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<h1>Hello <div>There</div> now</h1> <h2>More <h3>Content</h3></h2>"
                );
        ...
        public virtual void TestSpanContents() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<span>Hello <div>there</div> <span>now</span></span>");
        ...
        public virtual void TestNoImagesInNoScriptInHead() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<html><head><noscript><img src='foo'></noscript></head><body><p>Hello</p></body></html>"
                );
        ...
        public virtual void TestAFlowContents() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<a>Hello <div>there</div> <span>now</span></a>");
        ...
        public virtual void TestFontFlowContents() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<font>Hello <div>there</div> <span>now</span></font>");
        ...
        public virtual void HandlesUnclosedTitleAtEof() {
            NUnit.Framework.Assert.AreEqual("Data", iText.Html2pdf.Jsoup.Jsoup.Parse("<title>Data").Title());
            NUnit.Framework.Assert.AreEqual("Data<", iText.Html2pdf.Jsoup.Jsoup.Parse("<title>Data<").Title());
            NUnit.Framework.Assert.AreEqual("Data</", iText.Html2pdf.Jsoup.Jsoup.Parse("<title>Data</").Title());
            NUnit.Framework.Assert.AreEqual("Data</t", iText.Html2pdf.Jsoup.Jsoup.Parse("<title>Data</t").Title());
            NUnit.Framework.Assert.AreEqual("Data</ti", iText.Html2pdf.Jsoup.Jsoup.Parse("<title>Data</ti").Title());
            NUnit.Framework.Assert.AreEqual("Data", iText.Html2pdf.Jsoup.Jsoup.Parse("<title>Data</title>").Title());
            NUnit.Framework.Assert.AreEqual("Data", iText.Html2pdf.Jsoup.Jsoup.Parse("<title>Data</title >").Title());
        }

        [NUnit.Framework.Test]
        public virtual void HandlesUnclosedTitle() {
            Document one = iText.Html2pdf.Jsoup.Jsoup.Parse("<title>One <b>Two <b>Three</TITLE><p>Test</p>");
            ...
            Document two = iText.Html2pdf.Jsoup.Jsoup.Parse("<title>One<b>Two <p>Test</p>");
        ...
        public virtual void HandlesUnclosedScriptAtEof() {
            NUnit.Framework.Assert.AreEqual("Data", iText.Html2pdf.Jsoup.Jsoup.Parse("<script>Data").Select("script").
                First().Data());
            NUnit.Framework.Assert.AreEqual("Data<", iText.Html2pdf.Jsoup.Jsoup.Parse("<script>Data<").Select("script"
                ).First().Data());
            NUnit.Framework.Assert.AreEqual("Data</sc", iText.Html2pdf.Jsoup.Jsoup.Parse("<script>Data</sc").Select("script"
                ).First().Data());
            NUnit.Framework.Assert.AreEqual("Data</-sc", iText.Html2pdf.Jsoup.Jsoup.Parse("<script>Data</-sc").Select(
                "script").First().Data());
            NUnit.Framework.Assert.AreEqual("Data</sc-", iText.Html2pdf.Jsoup.Jsoup.Parse("<script>Data</sc-").Select(
                "script").First().Data());
            NUnit.Framework.Assert.AreEqual("Data</sc--", iText.Html2pdf.Jsoup.Jsoup.Parse("<script>Data</sc--").Select
                ("script").First().Data());
            NUnit.Framework.Assert.AreEqual("Data", iText.Html2pdf.Jsoup.Jsoup.Parse("<script>Data</script>").Select("script"
                ).First().Data());
            NUnit.Framework.Assert.AreEqual("Data</script", iText.Html2pdf.Jsoup.Jsoup.Parse("<script>Data</script").Select
                ("script").First().Data());
            NUnit.Framework.Assert.AreEqual("Data", iText.Html2pdf.Jsoup.Jsoup.Parse("<script>Data</script ").Select("script"
                ).First().Data());
            NUnit.Framework.Assert.AreEqual("Data", iText.Html2pdf.Jsoup.Jsoup.Parse("<script>Data</script n").Select(
                "script").First().Data());
            NUnit.Framework.Assert.AreEqual("Data", iText.Html2pdf.Jsoup.Jsoup.Parse("<script>Data</script n=").Select
                ("script").First().Data());
            NUnit.Framework.Assert.AreEqual("Data", iText.Html2pdf.Jsoup.Jsoup.Parse("<script>Data</script n=\"").Select
                ("script").First().Data());
            NUnit.Framework.Assert.AreEqual("Data", iText.Html2pdf.Jsoup.Jsoup.Parse("<script>Data</script n=\"p").Select
                ("script").First().Data());
        }

        [NUnit.Framework.Test]
        public virtual void HandlesUnclosedRawtextAtEof() {
            NUnit.Framework.Assert.AreEqual("Data", iText.Html2pdf.Jsoup.Jsoup.Parse("<style>Data").Select("style").First
                ().Data());
            NUnit.Framework.Assert.AreEqual("Data</st", iText.Html2pdf.Jsoup.Jsoup.Parse("<style>Data</st").Select("style"
                ).First().Data());
            NUnit.Framework.Assert.AreEqual("Data", iText.Html2pdf.Jsoup.Jsoup.Parse("<style>Data</style>").Select("style"
                ).First().Data());
            NUnit.Framework.Assert.AreEqual("Data</style", iText.Html2pdf.Jsoup.Jsoup.Parse("<style>Data</style").Select
                ("style").First().Data());
            NUnit.Framework.Assert.AreEqual("Data</-style", iText.Html2pdf.Jsoup.Jsoup.Parse("<style>Data</-style").Select
                ("style").First().Data());
            NUnit.Framework.Assert.AreEqual("Data</style-", iText.Html2pdf.Jsoup.Jsoup.Parse("<style>Data</style-").Select
                ("style").First().Data());
            NUnit.Framework.Assert.AreEqual("Data</style--", iText.Html2pdf.Jsoup.Jsoup.Parse("<style>Data</style--").
        ...
        public virtual void NoImplicitFormForTextAreas() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<textarea>One</textarea>");
            NUnit.Framework.Assert.AreEqual("<textarea>One</textarea>", doc.Body().Html());
        }

        [NUnit.Framework.Test]
        public virtual void HandlesEscapedScript() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<script><!-- one <script>Blah</script> --></script>");
        ...
        public virtual void Handles0CharacterAsText() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("0<p>0</p>");
            NUnit.Framework.Assert.AreEqual("0\n<p>0</p>", doc.Body().Html());
        }

        [NUnit.Framework.Test]
        public virtual void HandlesNullInData() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p id=\u0000>Blah \u0000</p>");
        ...
        public virtual void TracksErrorsWhenRequested() {
            ...
            iText.Html2pdf.Jsoup.Parser.Parser parser = iText.Html2pdf.Jsoup.Parser.Parser.HtmlParser().SetTrackErrors
                (500);
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(html, "http://example.com", parser);
        ...
        public virtual void NoErrorsByDefault() {
            ...
            iText.Html2pdf.Jsoup.Parser.Parser parser = iText.Html2pdf.Jsoup.Parser.Parser.HtmlParser();
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(html, "http://example.com", parser);
            IList<ParseError> errors = parser.GetErrors();
        ...
        public virtual void HandlesCommentsInTable() {
            ...
            Document node = iText.Html2pdf.Jsoup.Jsoup.ParseBodyFragment(html);
        ...
        public virtual void HandleNullContextInParseFragment() {
            ...
            IList<Node> nodes = iText.Html2pdf.Jsoup.Parser.Parser.ParseFragment(html, null, "http://example.com/");
            ...
            NUnit.Framework.Assert.AreEqual("<html> <head></head> <body> <ol> <li>One</li> </ol> <p>Two</p> </body> </html>"
                , iText.Html2pdf.Jsoup.Helper.StringUtil.NormaliseWhitespace(nodes[0].OuterHtml()));
        }
        ...
        public virtual void DoesNotFindShortestMatchingEntity() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(html);
            NUnit.Framework.Assert.AreEqual(iText.Html2pdf.Jsoup.Helper.StringUtil.NormaliseWhitespace("One &amp;clubsuite; ♣"
                ), doc.Body().Html());
        }
        ...
        public virtual void HandlesXmlDeclarationAsBogusComment() {
            ...
            NUnit.Framework.Assert.AreEqual("<!--?xml encoding='UTF-8' ?--> <html> <head></head> <body> One </body> </html>"
                , iText.Html2pdf.Jsoup.Helper.StringUtil.NormaliseWhitespace(doc.OuterHtml()));
        }
        ...
        public virtual void CreatesFormElements() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(html);
            iText.Html2pdf.Jsoup.Nodes.Element el = doc.Select("form").First();
        ...
        public virtual void HandlesInvalidDoctypes() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<!DOCTYPE>");
            NUnit.Framework.Assert.AreEqual("<!doctype> <html> <head></head> <body></body> </html>", iText.Html2pdf.Jsoup.Helper.StringUtil
                .NormaliseWhitespace(doc.OuterHtml()));
            doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<!DOCTYPE><html><p>Foo</p></html>");
            NUnit.Framework.Assert.AreEqual("<!doctype> <html> <head></head> <body> <p>Foo</p> </body> </html>", iText.Html2pdf.Jsoup.Helper.StringUtil
                .NormaliseWhitespace(doc.OuterHtml()));
            doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<!DOCTYPE \u0000>");
            NUnit.Framework.Assert.AreEqual("<!doctype �> <html> <head></head> <body></body> </html>", iText.Html2pdf.Jsoup.Helper.StringUtil
                .NormaliseWhitespace(doc.OuterHtml()));
        }
        ...
        public virtual void TestNormalisesIsIndex() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<body><isindex action='/submit'></body>");
            ...
            NUnit.Framework.Assert.AreEqual("<form action=\"/submit\"> <hr> <label>This is a searchable index. Enter search keywords: <input name=\"isindex\"></label> <hr> </form>"
                , iText.Html2pdf.Jsoup.Helper.StringUtil.NormaliseWhitespace(doc.Body().Html()));
        }
