...
namespace iText.Html2pdf.Jsoup.Safety {
    ...
    public class CleanerTest {
        ...
        public virtual void SimpleBehaviourTest() {
            ...
            String cleanHtml = iText.Html2pdf.Jsoup.Jsoup.Clean(h, Whitelist.SimpleText());
        ...
        public virtual void BasicBehaviourTest() {
            ...
            String cleanHtml = iText.Html2pdf.Jsoup.Jsoup.Clean(h, Whitelist.Basic());
        ...
        public virtual void BasicWithImagesTest() {
            ...
            String cleanHtml = iText.Html2pdf.Jsoup.Jsoup.Clean(h, Whitelist.BasicWithImages());
        ...
        public virtual void TestRelaxed() {
            ...
            String cleanHtml = iText.Html2pdf.Jsoup.Jsoup.Clean(h, Whitelist.Relaxed());
        ...
        public virtual void TestRemoveTags() {
            ...
            String cleanHtml = iText.Html2pdf.Jsoup.Jsoup.Clean(h, Whitelist.Basic().RemoveTags("a"));
        ...
        public virtual void TestRemoveAttributes() {
            ...
            String cleanHtml = iText.Html2pdf.Jsoup.Jsoup.Clean(h, Whitelist.Basic().RemoveAttributes("blockquote", "cite"
                ));
            NUnit.Framework.Assert.AreEqual("<p>Nice</p><blockquote>Hello</blockquote>", TextUtil.StripNewlines(cleanHtml
                ));
        }
        ...
        public virtual void TestRemoveEnforcedAttributes() {
            String h = "<div><p><A HREF='HTTP://nice.com/'>Nice</a></p><blockquote>Hello</blockquote>";
            String cleanHtml = iText.Html2pdf.Jsoup.Jsoup.Clean(h, Whitelist.Basic().RemoveEnforcedAttribute("a", "rel"
                ));
        ...
        public virtual void TestRemoveProtocols() {
            ...
            String cleanHtml = iText.Html2pdf.Jsoup.Jsoup.Clean(h, Whitelist.Basic().RemoveProtocols("a", "href", "ftp"
                , "mailto"));
        ...
        public virtual void TestCleanAnchorProtocol() {
            ...
            String cleanHtml = iText.Html2pdf.Jsoup.Jsoup.Clean(validAnchor, Whitelist.Relaxed());
            NUnit.Framework.Assert.AreEqual("<a>Valid anchor</a>", cleanHtml);
            cleanHtml = iText.Html2pdf.Jsoup.Jsoup.Clean(invalidAnchor, Whitelist.Relaxed());
            ...
            cleanHtml = iText.Html2pdf.Jsoup.Jsoup.Clean(validAnchor, relaxedWithAnchor);
            NUnit.Framework.Assert.AreEqual(validAnchor, cleanHtml);
            // An invalid anchor is never valid.
            cleanHtml = iText.Html2pdf.Jsoup.Jsoup.Clean(invalidAnchor, relaxedWithAnchor);
            NUnit.Framework.Assert.AreEqual("<a>Invalid anchor</a>", cleanHtml);
        }
        ...
        public virtual void TestIsValid() {
            ...
            NUnit.Framework.Assert.IsTrue(iText.Html2pdf.Jsoup.Jsoup.IsValid(ok, Whitelist.Basic()));
            NUnit.Framework.Assert.IsFalse(iText.Html2pdf.Jsoup.Jsoup.IsValid(nok1, Whitelist.Basic()));
            NUnit.Framework.Assert.IsFalse(iText.Html2pdf.Jsoup.Jsoup.IsValid(nok2, Whitelist.Basic()));
            NUnit.Framework.Assert.IsFalse(iText.Html2pdf.Jsoup.Jsoup.IsValid(nok3, Whitelist.Basic()));
        }

        [NUnit.Framework.Test]
        public virtual void ResolvesRelativeLinks() {
            String html = "<a href='/foo'>Link</a><img src='/bar'>";
            String clean = iText.Html2pdf.Jsoup.Jsoup.Clean(html, "http://example.com/", Whitelist.BasicWithImages());
        ...
        public virtual void PreservesRelativeLinksIfConfigured() {
            ...
            String clean = iText.Html2pdf.Jsoup.Jsoup.Clean(html, "http://example.com/", Whitelist.BasicWithImages().PreserveRelativeLinks
                (true));
        ...
        public virtual void DropsUnresolvableRelativeLinks() {
            ...
            String clean = iText.Html2pdf.Jsoup.Jsoup.Clean(html, Whitelist.Basic());
        ...
        public virtual void HandlesCustomProtocols() {
            ...
            String dropped = iText.Html2pdf.Jsoup.Jsoup.Clean(html, Whitelist.BasicWithImages());
            NUnit.Framework.Assert.AreEqual("<img> \n<img>", dropped);
            String preserved = iText.Html2pdf.Jsoup.Jsoup.Clean(html, Whitelist.BasicWithImages().AddProtocols("img", 
                "src", "cid", "data"));
        ...
        public virtual void HandlesAllPseudoTag() {
            ...
            Whitelist whitelist = new Whitelist().AddAttributes(":all", "class").AddAttributes("p", "style").AddTags("p"
                , "a");
            String clean = iText.Html2pdf.Jsoup.Jsoup.Clean(html, whitelist);
        ...
        public virtual void SupplyOutputSettings() {
            ...
            String customOut = iText.Html2pdf.Jsoup.Jsoup.Clean(html, "http://foo.com/", Whitelist.Relaxed(), os);
            String defaultOut = iText.Html2pdf.Jsoup.Jsoup.Clean(html, "http://foo.com/", Whitelist.Relaxed());
            ...
            String customOut2 = iText.Html2pdf.Jsoup.Jsoup.Clean(html, "http://foo.com/", Whitelist.Relaxed(), os);
        ...
        public virtual void HandlesFramesets() {
            ...
            String clean = iText.Html2pdf.Jsoup.Jsoup.Clean(dirty, Whitelist.Basic());
            NUnit.Framework.Assert.AreEqual("", clean);
            // nothing good can come out of that
            Document dirtyDoc = iText.Html2pdf.Jsoup.Jsoup.Parse(dirty);
        ...
        public virtual void CleansInternationalText() {
            NUnit.Framework.Assert.AreEqual("привет", iText.Html2pdf.Jsoup.Jsoup.Clean("привет", Whitelist.None()));
        }
        ...
        public virtual void TestScriptTagInWhiteList() {
            ...
            NUnit.Framework.Assert.IsTrue(iText.Html2pdf.Jsoup.Jsoup.IsValid("Hello<script>alert('Doh')</script>World !"
                , whitelist));
        }
    }
}
