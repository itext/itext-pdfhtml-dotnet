...
namespace iText.Html2pdf.Jsoup.Nodes {
    ...
    public class FormElementTest {
        ...
        public virtual void FormsAddedAfterParseAreFormElements() {
            ...
            iText.Html2pdf.Jsoup.Nodes.Element formEl = doc.Select("form").First();
        ...
        public virtual void UsesOnForCheckboxValueIfNoValueSet() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<form><input type=checkbox checked name=foo></form>");
            FormElement form = (FormElement)doc.Select("form").First();
            IList<KeyVal> data = form.FormData();
