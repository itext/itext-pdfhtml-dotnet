...
namespace iText.Html2pdf.Jsoup.Nodes {
    ...
    public class ElementTest {
        ...
        public virtual void GetElementsByTagName() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(reference);
            IList<iText.Html2pdf.Jsoup.Nodes.Element> divs = doc.GetElementsByTag("div");
            ...
            IList<iText.Html2pdf.Jsoup.Nodes.Element> ps = doc.GetElementsByTag("p");
            ...
            IList<iText.Html2pdf.Jsoup.Nodes.Element> ps2 = doc.GetElementsByTag("P");
            NUnit.Framework.Assert.AreEqual(ps, ps2);
            IList<iText.Html2pdf.Jsoup.Nodes.Element> imgs = doc.GetElementsByTag("img");
            NUnit.Framework.Assert.AreEqual("foo.png", imgs[0].Attr("src"));
            IList<iText.Html2pdf.Jsoup.Nodes.Element> empty = doc.GetElementsByTag("wtf");
            NUnit.Framework.Assert.AreEqual(0, empty.Count);
        }

        [NUnit.Framework.Test]
        public virtual void GetNamespacedElementsByTag() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><abc:def id=1>Hello</abc:def></div>");
        ...
        public virtual void TestGetElementById() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(reference);
            iText.Html2pdf.Jsoup.Nodes.Element div = doc.GetElementById("div1");
            NUnit.Framework.Assert.AreEqual("div1", div.Id());
            NUnit.Framework.Assert.IsNull(doc.GetElementById("none"));
            Document doc2 = iText.Html2pdf.Jsoup.Jsoup.Parse("<div id=1><div id=2><p>Hello <span id=2>world!</span></p></div></div>"
                );
            iText.Html2pdf.Jsoup.Nodes.Element div2 = doc2.GetElementById("2");
            NUnit.Framework.Assert.AreEqual("div", div2.TagName());
            // not the span
            iText.Html2pdf.Jsoup.Nodes.Element span = div2.Child(0).GetElementById("2");
        ...
        public virtual void TestGetChildText() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p>Hello <b>there</b> now");
        ...
        public virtual void TestNormalisesText() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(h);
        ...
        public virtual void TestBrHasSpace() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p>Hello<br>there</p>");
            ...
            doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p>Hello <br> there</p>");
            NUnit.Framework.Assert.AreEqual("Hello there", doc.Text());
        }

        [NUnit.Framework.Test]
        public virtual void TestGetSiblings() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p>Hello<p id=1>there<p>this<p>is<p>an<p id=last>element</div>"
                );
            iText.Html2pdf.Jsoup.Nodes.Element p = doc.GetElementById("1");
        ...
        public virtual void TestGetSiblingsWithDuplicateContent() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p>Hello<p id=1>there<p>this<p>this<p>is<p>an<p id=last>element</div>"
                );
            iText.Html2pdf.Jsoup.Nodes.Element p = doc.GetElementById("1");
            NUnit.Framework.Assert.AreEqual("there", p.Text());
            NUnit.Framework.Assert.AreEqual("Hello", p.PreviousElementSibling().Text());
        ...
        public virtual void TestGetParents() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p>Hello <span>there</span></div>");
        ...
        public virtual void TestElementSiblingIndex() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p>One</p>...<p>Two</p>...<p>Three</p>");
        ...
        public virtual void TestElementSiblingIndexSameContent() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p>One</p>...<p>One</p>...<p>One</p>");
            Elements ps = doc.Select("p");
            NUnit.Framework.Assert.IsTrue(0 == ps[0].ElementSiblingIndex());
            NUnit.Framework.Assert.IsTrue(1 == ps[1].ElementSiblingIndex());
            NUnit.Framework.Assert.IsTrue(2 == ps[2].ElementSiblingIndex());
        ...
        public virtual void TestGetElementsWithClass() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div class='mellow yellow'><span class=mellow>Hello <b class='yellow'>Yellow!</b></span><p>Empty</p></div>"
                );
            IList<iText.Html2pdf.Jsoup.Nodes.Element> els = doc.GetElementsByClass("mellow");
            ...
            IList<iText.Html2pdf.Jsoup.Nodes.Element> els2 = doc.GetElementsByClass("yellow");
            ...
            IList<iText.Html2pdf.Jsoup.Nodes.Element> none = doc.GetElementsByClass("solo");
            NUnit.Framework.Assert.AreEqual(0, none.Count);
        }

        [NUnit.Framework.Test]
        public virtual void TestGetElementsWithAttribute() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div style='bold'><p title=qux><p><b style></b></p></div>"
                );
            IList<iText.Html2pdf.Jsoup.Nodes.Element> els = doc.GetElementsByAttribute("style");
            NUnit.Framework.Assert.AreEqual(2, els.Count);
            NUnit.Framework.Assert.AreEqual("div", els[0].TagName());
            NUnit.Framework.Assert.AreEqual("b", els[1].TagName());
            IList<iText.Html2pdf.Jsoup.Nodes.Element> none = doc.GetElementsByAttribute("class");
            NUnit.Framework.Assert.AreEqual(0, none.Count);
        }

        [NUnit.Framework.Test]
        public virtual void TestGetElementsWithAttributeDash() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<meta http-equiv=content-type value=utf8 id=1> <meta name=foo content=bar id=2> <div http-equiv=content-type value=utf8 id=3>"
                );
        ...
        public virtual void TestGetElementsWithAttributeValue() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div style='bold'><p><p><b style></b></p></div>");
            IList<iText.Html2pdf.Jsoup.Nodes.Element> els = doc.GetElementsByAttributeValue("style", "bold");
            NUnit.Framework.Assert.AreEqual(1, els.Count);
            NUnit.Framework.Assert.AreEqual("div", els[0].TagName());
            IList<iText.Html2pdf.Jsoup.Nodes.Element> none = doc.GetElementsByAttributeValue("style", "none");
            NUnit.Framework.Assert.AreEqual(0, none.Count);
        }

        [NUnit.Framework.Test]
        public virtual void TestClassDomMethods() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><span class=' mellow yellow '>Hello <b>Yellow</b></span></div>"
                );
            IList<iText.Html2pdf.Jsoup.Nodes.Element> els = doc.GetElementsByAttribute("class");
            iText.Html2pdf.Jsoup.Nodes.Element span = els[0];
        ...
        public virtual void TestClassUpdates() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div class='mellow yellow'></div>");
            iText.Html2pdf.Jsoup.Nodes.Element div = doc.Select("div").First();
            div.AddClass("green");
        ...
        public virtual void TestOuterHtml() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div title='Tags &amp;c.'><img src=foo.png><p><!-- comment -->Hello<p>there"
                );
        ...
        public virtual void TestInnerHtml() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div>\n <p>Hello</p> </div>");
            NUnit.Framework.Assert.AreEqual("<p>Hello</p>", doc.GetElementsByTag("div")[0].Html());
        }

        [NUnit.Framework.Test]
        public virtual void TestFormatHtml() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<title>Format test</title><div><p>Hello <span>jsoup <span>users</span></span></p><p>Good.</p></div>"
                );
        ...
        public virtual void TestSetIndent() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p>Hello\nthere</p></div>");
        ...
        public virtual void TestEmptyElementFormatHtml() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<section><div></div></section>");
        ...
        public virtual void TestNoIndentOnScriptAndStyle() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<script>one\ntwo</script>\n<style>three\nfour</style>");
        ...
        public virtual void TestContainerOutput() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<title>Hello there</title> <div><p>Hello</p><p>there</p></div> <div>Another</div>"
                );
        ...
        public virtual void TestSetText() {
            ...
            iText.Html2pdf.Jsoup.Nodes.Element div = doc.GetElementById("1").Text("Gone");
        ...
        public virtual void TestAddNewElement() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div id=1><p>Hello</p></div>");
            iText.Html2pdf.Jsoup.Nodes.Element div = doc.GetElementById("1");
            div.AppendElement("p").Text("there");
            ((iText.Html2pdf.Jsoup.Nodes.Element)div.AppendElement("P").Attr("class", "second")).Text("now");
        ...
        public virtual void TestAddBooleanAttribute() {
            iText.Html2pdf.Jsoup.Nodes.Element div = new iText.Html2pdf.Jsoup.Nodes.Element(iText.Html2pdf.Jsoup.Parser.Tag
                .ValueOf("div"), "");
            div.Attr("true", true);
            ...
            IList<iText.Html2pdf.Jsoup.Nodes.Attribute> attributes = div.Attributes().AsList();
        ...
        public virtual void TestAppendRowToTable() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<table><tr><td>1</td></tr></table>");
            iText.Html2pdf.Jsoup.Nodes.Element table = doc.Select("tbody").First();
        ...
        public virtual void TestSetHtmlTitle() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<html><head id=2><title id=1></title></head></html>");
            iText.Html2pdf.Jsoup.Nodes.Element title = doc.GetElementById("1");
            title.Html("good");
            NUnit.Framework.Assert.AreEqual("good", title.Html());
            title.Html("<i>bad</i>");
            NUnit.Framework.Assert.AreEqual("&lt;i&gt;bad&lt;/i&gt;", title.Html());
            iText.Html2pdf.Jsoup.Nodes.Element head = doc.GetElementById("2");
        ...
        public virtual void TestWrap() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p>Hello</p><p>There</p></div>");
            iText.Html2pdf.Jsoup.Nodes.Element p = doc.Select("p").First();
        ...
        public virtual void Before() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p>Hello</p><p>There</p></div>");
            iText.Html2pdf.Jsoup.Nodes.Element p1 = doc.Select("p").First();
        ...
        public virtual void TestWrapWithRemainder() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p>Hello</p></div>");
            iText.Html2pdf.Jsoup.Nodes.Element p = doc.Select("p").First();
        ...
        public virtual void TestHasText() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><p>Hello</p><p></p></div>");
            iText.Html2pdf.Jsoup.Nodes.Element div = doc.Select("div").First();
            Elements ps = doc.Select("p");
        ...
        public virtual void Dataset() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div id=1 data-name=jsoup class=new data-package=jar>Hello</div><p id=2>Hello</p>"
                );
            iText.Html2pdf.Jsoup.Nodes.Element div = doc.Select("div").First();
        ...
        public virtual void ParentlessToString() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<img src='foo'>");
        ...
        public virtual void TestClonesClassnames() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div class='one two'></div>");
            iText.Html2pdf.Jsoup.Nodes.Element div = doc.Select("div").First();
            ...
            iText.Html2pdf.Jsoup.Nodes.Element copy = (iText.Html2pdf.Jsoup.Nodes.Element)div.Clone();
        ...
        public virtual void TestTagNameSet() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div><i>Hello</i>");
        ...
        public virtual void TestHtmlContainsOuter() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<title>Check</title> <div>Hello there</div>");
            doc.OutputSettings().IndentAmount(0);
        ...
        public virtual void TestGetTextNodes() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p>One <span>Two</span> Three <br> Four</p>");
        ...
        public virtual void TestGetDataNodes() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<script>One Two</script> <style>Three Four</style> <p>Fix Six</p>"
                );
            iText.Html2pdf.Jsoup.Nodes.Element script = doc.Select("script").First();
            iText.Html2pdf.Jsoup.Nodes.Element style = doc.Select("style").First();
            iText.Html2pdf.Jsoup.Nodes.Element p = doc.Select("p").First();
        ...
        public virtual void MoveByAppend() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div id=1>Text <p>One</p> Text <p>Two</p></div><div id=2></div>"
                );
            iText.Html2pdf.Jsoup.Nodes.Element div1 = doc.Select("div")[0];
            iText.Html2pdf.Jsoup.Nodes.Element div2 = doc.Select("div")[1];
            NUnit.Framework.Assert.AreEqual(4, div1.ChildNodeSize());
            IList<Node> children = div1.ChildNodes();
        ...
        public virtual void InsertChildrenArgumentValidation() {
            ...
            try {
                div2.InsertChildren<Node>(0, null);
                NUnit.Framework.Assert.Fail();
            }
            catch (ArgumentException) {
            }
        ...
        public virtual void InsertChildrenAtPosition() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div id=1>Text1 <p>One</p> Text2 <p>Two</p></div><div id=2>Text3 <p>Three</p></div>"
                );
            iText.Html2pdf.Jsoup.Nodes.Element div1 = doc.Select("div")[0];
            ...
            // should be last
            IList<Node> els = new List<Node>();
            iText.Html2pdf.Jsoup.Nodes.Element el1 = new iText.Html2pdf.Jsoup.Nodes.Element(iText.Html2pdf.Jsoup.Parser.Tag
                .ValueOf("span"), "").Text("Span1");
            iText.Html2pdf.Jsoup.Nodes.Element el2 = new iText.Html2pdf.Jsoup.Nodes.Element(iText.Html2pdf.Jsoup.Parser.Tag
        ...
        public virtual void TestCssPath() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div id=\"id1\">A</div><div>B</div><div class=\"c1 c2\">C</div>"
                );
            iText.Html2pdf.Jsoup.Nodes.Element divA = doc.Select("div")[0];
            iText.Html2pdf.Jsoup.Nodes.Element divB = doc.Select("div")[1];
            iText.Html2pdf.Jsoup.Nodes.Element divC = doc.Select("div")[2];
        ...
        public virtual void TestClassNames() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<div class=\"c1 c2\">C</div>");
            iText.Html2pdf.Jsoup.Nodes.Element div = doc.Select("div")[0];
        ...
        public virtual void TestHashAndEqualsAndValue() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(doc1);
            ...
            */
            ...
            iText.Html2pdf.Jsoup.Nodes.Element e0 = els[0];
            iText.Html2pdf.Jsoup.Nodes.Element e1 = els[1];
            iText.Html2pdf.Jsoup.Nodes.Element e2 = els[2];
            iText.Html2pdf.Jsoup.Nodes.Element e3 = els[3];
            iText.Html2pdf.Jsoup.Nodes.Element e4 = els[4];
            iText.Html2pdf.Jsoup.Nodes.Element e5 = els[5];
            iText.Html2pdf.Jsoup.Nodes.Element e6 = els[6];
            iText.Html2pdf.Jsoup.Nodes.Element e7 = els[7];
        ...
        public virtual void TestRelativeUrls() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(html, "http://example.com/bar/");
        ...
        public virtual void AppendMustCorrectlyMoveChildrenInsideOneParentElement() {
            ...
            iText.Html2pdf.Jsoup.Nodes.Element body = doc.AppendElement("body");
            body.AppendElement("div1");
            body.AppendElement("div2");
            iText.Html2pdf.Jsoup.Nodes.Element div3 = body.AppendElement("div3");
            div3.Text("Check");
            iText.Html2pdf.Jsoup.Nodes.Element div4 = body.AppendElement("div4");
            List<iText.Html2pdf.Jsoup.Nodes.Element> toMove = new List<iText.Html2pdf.Jsoup.Nodes.Element>();
            toMove.Add(div3);
            toMove.Add(div4);
        ...
        public virtual void TestHashcodeIsStableWithContentChanges() {
            iText.Html2pdf.Jsoup.Nodes.Element root = new iText.Html2pdf.Jsoup.Nodes.Element(iText.Html2pdf.Jsoup.Parser.Tag
                .ValueOf("root"), "");
            HashSet<iText.Html2pdf.Jsoup.Nodes.Element> set = new HashSet<iText.Html2pdf.Jsoup.Nodes.Element>();
            // Add root node:
            set.Add(root);
            root.AppendChild(new iText.Html2pdf.Jsoup.Nodes.Element(iText.Html2pdf.Jsoup.Parser.Tag.ValueOf("a"), ""));
