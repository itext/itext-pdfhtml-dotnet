...
namespace iText.Html2pdf.Jsoup.Nodes {
    ...
    public class DocumentTest {
        ...
        public virtual void SetTextPreservesDocumentStructure() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p>Hello</p>");
            doc.Text("Replaced");
        ...
        public virtual void TestTitles() {
            Document noTitle = iText.Html2pdf.Jsoup.Jsoup.Parse("<p>Hello</p>");
            Document withTitle = iText.Html2pdf.Jsoup.Jsoup.Parse("<title>First</title><title>Ignore</title><p>Hello</p>"
                );
            ...
            Document normaliseTitle = iText.Html2pdf.Jsoup.Jsoup.Parse("<title>   Hello\nthere   \n   now   \n");
            NUnit.Framework.Assert.AreEqual("Hello there now", normaliseTitle.Title());
        }

        [NUnit.Framework.Test]
        public virtual void TestOutputEncoding() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<p title=π>π & < > </p>");
            // default is utf-8
        ...
        public virtual void TestXhtmlReferences() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("&lt; &gt; &amp; &quot; &apos; &times;");
        ...
        public virtual void TestNormalisesStructure() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("<html><head><script>one</script><noscript><p>two</p></noscript></head><body><p>three</p></body><p>four</p></html>"
                );
        ...
        public virtual void HtmlParseDefaultsToHtmlOutputSyntax() {
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse("x");
        ...
        public virtual void TestHtmlAppendable() {
            ...
            Document document = iText.Html2pdf.Jsoup.Jsoup.Parse(htmlContent);
        ...
        public virtual void TestOverflowClone() {
            ...
            Document doc = iText.Html2pdf.Jsoup.Jsoup.Parse(builder.ToString());
            doc.Clone();
        }
        ...
        public virtual void DocumentsWithSameContentAreEqual() {
            Document docA = iText.Html2pdf.Jsoup.Jsoup.Parse("<div/>One");
            Document docB = iText.Html2pdf.Jsoup.Jsoup.Parse("<div/>One");
            Document docC = iText.Html2pdf.Jsoup.Jsoup.Parse("<div/>Two");
