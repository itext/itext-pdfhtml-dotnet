...
namespace Org.Jsoup.Nodes {
    ...
    public class DocumentTest {
        ...
        public virtual void TestMetaCharsetUpdateUtf8() {
            ...
            doc.Charset(System.Text.Encoding.GetEncoding(charsetUtf8));
        ...
        public virtual void TestMetaCharsetUpdateIso8859() {
            Document doc = CreateHtmlDocument("changeThis");
            doc.UpdateMetaCharsetElement(true);
            doc.Charset(System.Text.Encoding.GetEncoding(charsetIso8859));
        ...
        public virtual void TestMetaCharsetUpdateNoCharset() {
            ...
            docNoCharset.Charset(System.Text.Encoding.GetEncoding(charsetUtf8));
        ...
        public virtual void TestShiftJisRoundtrip() {
            ...
            Stream @is = new MemoryStream(input.GetBytes(System.Text.Encoding.GetEncoding("ASCII")));
