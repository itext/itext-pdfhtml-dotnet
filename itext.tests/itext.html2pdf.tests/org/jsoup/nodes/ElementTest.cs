...
namespace Org.Jsoup.Nodes {
    ...
    public class ElementTest {
        ...
        public virtual void GetElementsByTagName() {
            Document doc = Org.Jsoup.Jsoup.Parse(reference);
            IList<Element> divs = doc.GetElementsByTag("div");
            ...
            IList<Element> ps = doc.GetElementsByTag("p");
            ...
            IList<Element> ps2 = doc.GetElementsByTag("P");
            NUnit.Framework.Assert.AreEqual(ps, ps2);
            IList<Element> imgs = doc.GetElementsByTag("img");
            NUnit.Framework.Assert.AreEqual("foo.png", imgs[0].Attr("src"));
            IList<Element> empty = doc.GetElementsByTag("wtf");
            NUnit.Framework.Assert.AreEqual(0, empty.Count);
        }

        [NUnit.Framework.Test]
        public virtual void GetNamespacedElementsByTag() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div><abc:def id=1>Hello</abc:def></div>");
        ...
        public virtual void TestGetElementById() {
            ...
            Document doc2 = Org.Jsoup.Jsoup.Parse("<div id=1><div id=2><p>Hello <span id=2>world!</span></p></div></div>"
                );
        ...
        public virtual void TestGetChildText() {
            Document doc = Org.Jsoup.Jsoup.Parse("<p>Hello <b>there</b> now");
        ...
        public virtual void TestBrHasSpace() {
            Document doc = Org.Jsoup.Jsoup.Parse("<p>Hello<br>there</p>");
        ...
        public virtual void TestGetSiblings() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div><p>Hello<p id=1>there<p>this<p>is<p>an<p id=last>element</div>"
                );
        ...
        public virtual void TestGetSiblingsWithDuplicateContent() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div><p>Hello<p id=1>there<p>this<p>this<p>is<p>an<p id=last>element</div>"
                );
            Element p = doc.GetElementById("1");
            NUnit.Framework.Assert.AreEqual("there", p.Text());
            NUnit.Framework.Assert.AreEqual("Hello", p.PreviousElementSibling().Text());
        ...
        public virtual void TestGetParents() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div><p>Hello <span>there</span></div>");
        ...
        public virtual void TestElementSiblingIndex() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div><p>One</p>...<p>Two</p>...<p>Three</p>");
        ...
        public virtual void TestElementSiblingIndexSameContent() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div><p>One</p>...<p>One</p>...<p>One</p>");
            Elements ps = doc.Select("p");
            NUnit.Framework.Assert.IsTrue(0 == ps[0].ElementSiblingIndex());
            NUnit.Framework.Assert.IsTrue(1 == ps[1].ElementSiblingIndex());
            NUnit.Framework.Assert.IsTrue(2 == ps[2].ElementSiblingIndex());
        ...
        public virtual void TestGetElementsWithClass() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div class='mellow yellow'><span class=mellow>Hello <b class='yellow'>Yellow!</b></span><p>Empty</p></div>"
                );
            IList<Element> els = doc.GetElementsByClass("mellow");
            ...
            IList<Element> els2 = doc.GetElementsByClass("yellow");
            ...
            IList<Element> none = doc.GetElementsByClass("solo");
            NUnit.Framework.Assert.AreEqual(0, none.Count);
        }

        [NUnit.Framework.Test]
        public virtual void TestGetElementsWithAttribute() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div style='bold'><p title=qux><p><b style></b></p></div>");
            IList<Element> els = doc.GetElementsByAttribute("style");
            NUnit.Framework.Assert.AreEqual(2, els.Count);
            NUnit.Framework.Assert.AreEqual("div", els[0].TagName());
            NUnit.Framework.Assert.AreEqual("b", els[1].TagName());
            IList<Element> none = doc.GetElementsByAttribute("class");
            NUnit.Framework.Assert.AreEqual(0, none.Count);
        }

        [NUnit.Framework.Test]
        public virtual void TestGetElementsWithAttributeDash() {
            Document doc = Org.Jsoup.Jsoup.Parse("<meta http-equiv=content-type value=utf8 id=1> <meta name=foo content=bar id=2> <div http-equiv=content-type value=utf8 id=3>"
                );
        ...
        public virtual void TestGetElementsWithAttributeValue() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div style='bold'><p><p><b style></b></p></div>");
            IList<Element> els = doc.GetElementsByAttributeValue("style", "bold");
            NUnit.Framework.Assert.AreEqual(1, els.Count);
            NUnit.Framework.Assert.AreEqual("div", els[0].TagName());
            IList<Element> none = doc.GetElementsByAttributeValue("style", "none");
            NUnit.Framework.Assert.AreEqual(0, none.Count);
        }

        [NUnit.Framework.Test]
        public virtual void TestClassDomMethods() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div><span class=' mellow yellow '>Hello <b>Yellow</b></span></div>"
                );
            IList<Element> els = doc.GetElementsByAttribute("class");
            Element span = els[0];
        ...
        public virtual void TestClassUpdates() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div class='mellow yellow'></div>");
        ...
        public virtual void TestOuterHtml() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div title='Tags &amp;c.'><img src=foo.png><p><!-- comment -->Hello<p>there"
                );
        ...
        public virtual void TestInnerHtml() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div>\n <p>Hello</p> </div>");
            NUnit.Framework.Assert.AreEqual("<p>Hello</p>", doc.GetElementsByTag("div")[0].Html());
        }

        [NUnit.Framework.Test]
        public virtual void TestFormatHtml() {
            Document doc = Org.Jsoup.Jsoup.Parse("<title>Format test</title><div><p>Hello <span>jsoup <span>users</span></span></p><p>Good.</p></div>"
                );
        ...
        public virtual void TestSetIndent() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div><p>Hello\nthere</p></div>");
        ...
        public virtual void TestEmptyElementFormatHtml() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse("<section><div></div></section>");
        ...
        public virtual void TestNoIndentOnScriptAndStyle() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse("<script>one\ntwo</script>\n<style>three\nfour</style>");
        ...
        public virtual void TestContainerOutput() {
            Document doc = Org.Jsoup.Jsoup.Parse("<title>Hello there</title> <div><p>Hello</p><p>there</p></div> <div>Another</div>"
                );
        ...
        public virtual void TestAddNewElement() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div id=1><p>Hello</p></div>");
        ...
        public virtual void TestAddBooleanAttribute() {
            Element div = new Element(Org.Jsoup.Parser.Tag.ValueOf("div"), "");
            div.Attr("true", true);
            ...
            IList<Org.Jsoup.Nodes.Attribute> attributes = div.Attributes().AsList();
        ...
        public virtual void TestAppendRowToTable() {
            Document doc = Org.Jsoup.Jsoup.Parse("<table><tr><td>1</td></tr></table>");
        ...
        public virtual void TestSetHtmlTitle() {
            Document doc = Org.Jsoup.Jsoup.Parse("<html><head id=2><title id=1></title></head></html>");
        ...
        public virtual void TestWrap() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div><p>Hello</p><p>There</p></div>");
            Element p = doc.Select("p").First();
        ...
        public virtual void TestWrapWithRemainder() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div><p>Hello</p></div>");
            Element p = doc.Select("p").First();
        ...
        public virtual void TestHasText() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div><p>Hello</p><p></p></div>");
            Element div = doc.Select("div").First();
            Elements ps = doc.Select("p");
        ...
        public virtual void Dataset() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div id=1 data-name=jsoup class=new data-package=jar>Hello</div><p id=2>Hello</p>"
                );
            Element div = doc.Select("div").First();
        ...
        public virtual void ParentlessToString() {
            Document doc = Org.Jsoup.Jsoup.Parse("<img src='foo'>");
        ...
        public virtual void TestClone() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div><p>One<p><span>Two</div>");
            Element p = doc.Select("p")[1];
            Element clone = (Element)p.Clone();
            NUnit.Framework.Assert.IsNull(((Element)clone.Parent()));
            // should be orphaned
            NUnit.Framework.Assert.AreEqual(0, clone.siblingIndex);
            NUnit.Framework.Assert.AreEqual(1, p.siblingIndex);
            NUnit.Framework.Assert.IsNotNull(((Element)p.Parent()));
            ...
            // adopt
            NUnit.Framework.Assert.IsNotNull(((Element)clone.Parent()));
        ...
        public virtual void TestClonesClassnames() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div class='one two'></div>");
            Element div = doc.Select("div").First();
        ...
        public virtual void TestTagNameSet() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div><i>Hello</i>");
        ...
        public virtual void TestHtmlContainsOuter() {
            Document doc = Org.Jsoup.Jsoup.Parse("<title>Check</title> <div>Hello there</div>");
            doc.OutputSettings().IndentAmount(0);
        ...
        public virtual void TestGetTextNodes() {
            Document doc = Org.Jsoup.Jsoup.Parse("<p>One <span>Two</span> Three <br> Four</p>");
        ...
        public virtual void TestGetDataNodes() {
            Document doc = Org.Jsoup.Jsoup.Parse("<script>One Two</script> <style>Three Four</style> <p>Fix Six</p>");
        ...
        public virtual void MoveByAppend() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse("<div id=1>Text <p>One</p> Text <p>Two</p></div><div id=2></div>");
            Element div1 = doc.Select("div")[0];
            Element div2 = doc.Select("div")[1];
        ...
        public virtual void InsertChildrenAtPosition() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div id=1>Text1 <p>One</p> Text2 <p>Two</p></div><div id=2>Text3 <p>Three</p></div>"
                );
            Element div1 = doc.Select("div")[0];
            ...
            Element el1 = new Element(Org.Jsoup.Parser.Tag.ValueOf("span"), "").Text("Span1");
            Element el2 = new Element(Org.Jsoup.Parser.Tag.ValueOf("span"), "").Text("Span2");
            TextNode tn1 = new TextNode("Text4", "");
            els.Add(el1);
            els.Add(el2);
            els.Add(tn1);
            NUnit.Framework.Assert.IsNull(((Element)el1.Parent()));
            div2.InsertChildren(-2, els);
            NUnit.Framework.Assert.AreEqual(div2, ((Element)el1.Parent()));
        ...
        public virtual void TestCssPath() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div id=\"id1\">A</div><div>B</div><div class=\"c1 c2\">C</div>");
            Element divA = doc.Select("div")[0];
            Element divB = doc.Select("div")[1];
            Element divC = doc.Select("div")[2];
        ...
        public virtual void TestClassNames() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div class=\"c1 c2\">C</div>");
            Element div = doc.Select("div")[0];
        ...
        public virtual void TestHashAndEqualsAndValue() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse(doc1);
        ...
        public virtual void TestRelativeUrls() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse(html, "http://example.com/bar/");
        ...
        public virtual void AppendMustCorrectlyMoveChildrenInsideOneParentElement() {
            ...
            List<Element> toMove = new List<Element>();
            toMove.Add(div3);
            toMove.Add(div4);
        ...
        public virtual void TestHashcodeIsStableWithContentChanges() {
            ...
            // Add root node:
            set.Add(root);
            root.AppendChild(new Element(Org.Jsoup.Parser.Tag.ValueOf("a"), ""));
