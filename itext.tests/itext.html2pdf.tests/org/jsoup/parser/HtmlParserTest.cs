...
namespace Org.Jsoup.Parser {
    ...
    public class HtmlParserTest {
        ...
        public virtual void DropsUnterminatedTag() {
            ...
            String h1 = "<p";
            Document doc = Org.Jsoup.Jsoup.Parse(h1);
        ...
        public virtual void ParsesUnterminatedTextarea() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse("<body><p><textarea>one<p>two");
        ...
        public virtual void ParsesUnterminatedOption() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse("<body><p><select><option>One<option>Two</p><p>Three</p>");
        ...
        public virtual void TestSpaceAfterTag() {
            Document doc = Org.Jsoup.Jsoup.Parse("<div > <a name=\"top\"></a ><p id=1 >Hello</p></div>");
        ...
        public virtual void HandlesDataOnlyTags() {
            ...
            IList<Element> tels = Org.Jsoup.Jsoup.Parse(t).GetElementsByTag("style");
        ...
        public virtual void HandlesTextArea() {
            Document doc = Org.Jsoup.Jsoup.Parse("<textarea>Hello</textarea>");
        ...
        public virtual void PreservesSpaceInTextArea() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse("<textarea>\n\tOne\n\tTwo\n\tThree\n</textarea>");
            String expect = "One\n\tTwo\n\tThree";
        ...
        public virtual void PreservesSpaceInScript() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse("<script>\nOne\n\tTwo\n\tThree\n</script>");
            String expect = "\nOne\n\tTwo\n\tThree\n";
        ...
        public virtual void DoesNotCreateImplicitLists() {
            ...
            NUnit.Framework.Assert.AreEqual("body", ((Element)lis.First().Parent()).TagName());
            // no fiddling with non-implicit lists
            String h2 = "<ol><li><p>Point the first<li><p>Point the second";
            Document doc2 = Org.Jsoup.Jsoup.Parse(h2);
        ...
        public virtual void HandlesNestedImplicitTable() {
            Document doc = Org.Jsoup.Jsoup.Parse("<table><td>1</td></tr> <td>2</td></tr> <td> <table><td>3</td> <td>4</td></table> <tr><td>5</table>"
                );
        ...
        public virtual void HandlesTbodyTable() {
            Document doc = Org.Jsoup.Jsoup.Parse("<html><head></head><body><table><tbody><tr><td>aaa</td><td>bbb</td></tr></tbody></table></body></html>"
                );
        ...
        public virtual void HandlesImplicitCaptionClose() {
            Document doc = Org.Jsoup.Jsoup.Parse("<table><caption>A caption<td>One<td>Two");
        ...
        public virtual void NoTableDirectInTable() {
            Document doc = Org.Jsoup.Jsoup.Parse("<table> <td>One <td><table><td>Two</table> <table><td>Three");
        ...
        public virtual void IgnoresDupeEndTrTag() {
            Document doc = Org.Jsoup.Jsoup.Parse("<table><tr><td>One</td><td><table><tr><td>Two</td></tr></tr></table></td><td>Three</td></tr></table>"
                );
        ...
        public virtual void HandlesBaseTags() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse(h, "http://foo/");
        ...
        public virtual void HandlesProtocolRelativeUrl() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse(html, @base);
        ...
        public virtual void HandlesUnknownInlineTags() {
            ...
            Document doc = Org.Jsoup.Jsoup.ParseBodyFragment(h);
        ...
        public virtual void ParsesBodyFragment() {
            ...
            Document doc = Org.Jsoup.Jsoup.ParseBodyFragment(h, "http://example.com");
        ...
        public virtual void HandlesBlocksInDefinitions() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse(h);
            NUnit.Framework.Assert.AreEqual("dt", ((Element)doc.Select("#1").First().Parent()).TagName());
            NUnit.Framework.Assert.AreEqual("dd", ((Element)doc.Select("#2").First().Parent()).TagName());
        ...
        public virtual void HandlesBaseWithoutHref() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse(h, "http://example.com/");
            Element a = doc.Select("a").First();
        ...
        public virtual void NormalisesHeadlessBody() {
            Document doc = Org.Jsoup.Jsoup.Parse("<html><body><span class=\"foo\">bar</span>");
        ...
        public virtual void NormalisedBodyAfterContent() {
            Document doc = Org.Jsoup.Jsoup.Parse("<font face=Arial><body class=name><div>One</div></body></font>");
        ...
        public virtual void TestHgroup() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse("<h1>Hello <h2>There <hgroup><h1>Another<h2>headline</hgroup> <hgroup><h1>More</h1><p>stuff</p></hgroup>"
                );
        ...
        public virtual void TestRelaxedTags() {
            Document doc = Org.Jsoup.Jsoup.Parse("<abc_def id=1>Hello</abc_def> <abc-def>There</abc-def>");
        ...
        public virtual void TestHeaderContents() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse("<h1>Hello <div>There</div> now</h1> <h2>More <h3>Content</h3></h2>");
        ...
        public virtual void TestSpanContents() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse("<span>Hello <div>there</div> <span>now</span></span>");
        ...
        public virtual void TestNoImagesInNoScriptInHead() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse("<html><head><noscript><img src='foo'></noscript></head><body><p>Hello</p></body></html>"
                );
        ...
        public virtual void TestAFlowContents() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse("<a>Hello <div>there</div> <span>now</span></a>");
        ...
        public virtual void TestFontFlowContents() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse("<font>Hello <div>there</div> <span>now</span></font>");
        ...
        public virtual void HandlesUnclosedTitleAtEof() {
            NUnit.Framework.Assert.AreEqual("Data", Org.Jsoup.Jsoup.Parse("<title>Data").Title());
            NUnit.Framework.Assert.AreEqual("Data<", Org.Jsoup.Jsoup.Parse("<title>Data<").Title());
            NUnit.Framework.Assert.AreEqual("Data</", Org.Jsoup.Jsoup.Parse("<title>Data</").Title());
            NUnit.Framework.Assert.AreEqual("Data</t", Org.Jsoup.Jsoup.Parse("<title>Data</t").Title());
            NUnit.Framework.Assert.AreEqual("Data</ti", Org.Jsoup.Jsoup.Parse("<title>Data</ti").Title());
            NUnit.Framework.Assert.AreEqual("Data", Org.Jsoup.Jsoup.Parse("<title>Data</title>").Title());
            NUnit.Framework.Assert.AreEqual("Data", Org.Jsoup.Jsoup.Parse("<title>Data</title >").Title());
        }

        [NUnit.Framework.Test]
        public virtual void HandlesUnclosedTitle() {
            Document one = Org.Jsoup.Jsoup.Parse("<title>One <b>Two <b>Three</TITLE><p>Test</p>");
            ...
            Document two = Org.Jsoup.Jsoup.Parse("<title>One<b>Two <p>Test</p>");
        ...
        public virtual void HandlesUnclosedScriptAtEof() {
            NUnit.Framework.Assert.AreEqual("Data", Org.Jsoup.Jsoup.Parse("<script>Data").Select("script").First().Data
                ());
            NUnit.Framework.Assert.AreEqual("Data<", Org.Jsoup.Jsoup.Parse("<script>Data<").Select("script").First().Data
                ());
            NUnit.Framework.Assert.AreEqual("Data</sc", Org.Jsoup.Jsoup.Parse("<script>Data</sc").Select("script").First
                ().Data());
            NUnit.Framework.Assert.AreEqual("Data</-sc", Org.Jsoup.Jsoup.Parse("<script>Data</-sc").Select("script").First
                ().Data());
            NUnit.Framework.Assert.AreEqual("Data</sc-", Org.Jsoup.Jsoup.Parse("<script>Data</sc-").Select("script").First
                ().Data());
            NUnit.Framework.Assert.AreEqual("Data</sc--", Org.Jsoup.Jsoup.Parse("<script>Data</sc--").Select("script")
                .First().Data());
            NUnit.Framework.Assert.AreEqual("Data", Org.Jsoup.Jsoup.Parse("<script>Data</script>").Select("script").First
                ().Data());
            NUnit.Framework.Assert.AreEqual("Data</script", Org.Jsoup.Jsoup.Parse("<script>Data</script").Select("script"
                ).First().Data());
            NUnit.Framework.Assert.AreEqual("Data", Org.Jsoup.Jsoup.Parse("<script>Data</script ").Select("script").First
                ().Data());
            NUnit.Framework.Assert.AreEqual("Data", Org.Jsoup.Jsoup.Parse("<script>Data</script n").Select("script").First
                ().Data());
            NUnit.Framework.Assert.AreEqual("Data", Org.Jsoup.Jsoup.Parse("<script>Data</script n=").Select("script").
                First().Data());
            NUnit.Framework.Assert.AreEqual("Data", Org.Jsoup.Jsoup.Parse("<script>Data</script n=\"").Select("script"
                ).First().Data());
            NUnit.Framework.Assert.AreEqual("Data", Org.Jsoup.Jsoup.Parse("<script>Data</script n=\"p").Select("script"
                ).First().Data());
        }

        [NUnit.Framework.Test]
        public virtual void HandlesUnclosedRawtextAtEof() {
            NUnit.Framework.Assert.AreEqual("Data", Org.Jsoup.Jsoup.Parse("<style>Data").Select("style").First().Data(
                ));
            NUnit.Framework.Assert.AreEqual("Data</st", Org.Jsoup.Jsoup.Parse("<style>Data</st").Select("style").First
                ().Data());
            NUnit.Framework.Assert.AreEqual("Data", Org.Jsoup.Jsoup.Parse("<style>Data</style>").Select("style").First
                ().Data());
            NUnit.Framework.Assert.AreEqual("Data</style", Org.Jsoup.Jsoup.Parse("<style>Data</style").Select("style")
                .First().Data());
            NUnit.Framework.Assert.AreEqual("Data</-style", Org.Jsoup.Jsoup.Parse("<style>Data</-style").Select("style"
                ).First().Data());
            NUnit.Framework.Assert.AreEqual("Data</style-", Org.Jsoup.Jsoup.Parse("<style>Data</style-").Select("style"
        ...
        public virtual void NoImplicitFormForTextAreas() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse("<textarea>One</textarea>");
            NUnit.Framework.Assert.AreEqual("<textarea>One</textarea>", doc.Body().Html());
        }

        [NUnit.Framework.Test]
        public virtual void HandlesEscapedScript() {
            Document doc = Org.Jsoup.Jsoup.Parse("<script><!-- one <script>Blah</script> --></script>");
        ...
        public virtual void Handles0CharacterAsText() {
            Document doc = Org.Jsoup.Jsoup.Parse("0<p>0</p>");
            NUnit.Framework.Assert.AreEqual("0\n<p>0</p>", doc.Body().Html());
        }

        [NUnit.Framework.Test]
        public virtual void HandlesNullInData() {
            Document doc = Org.Jsoup.Jsoup.Parse("<p id=\u0000>Blah \u0000</p>");
        ...
        public virtual void HandlesNewlinesAndWhitespaceInTag() {
            Document doc = Org.Jsoup.Jsoup.Parse("<a \n href=\"one\" \r\n id=\"two\" \f >");
        ...
        public virtual void TracksErrorsWhenRequested() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse(html, "http://example.com", parser);
        ...
        public virtual void HandlesCommentsInTable() {
            ...
            Document node = Org.Jsoup.Jsoup.ParseBodyFragment(html);
        ...
        public virtual void HandleNullContextInParseFragment() {
            ...
            IList<Node> nodes = Org.Jsoup.Parser.Parser.ParseFragment(html, null, "http://example.com/");
            ...
            NUnit.Framework.Assert.AreEqual("<html> <head></head> <body> <ol> <li>One</li> </ol> <p>Two</p> </body> </html>"
                , Org.Jsoup.Helper.StringUtil.NormaliseWhitespace(nodes[0].OuterHtml()));
        }
        ...
        public virtual void DoesNotFindShortestMatchingEntity() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse(html);
            NUnit.Framework.Assert.AreEqual(Org.Jsoup.Helper.StringUtil.NormaliseWhitespace("One &amp;clubsuite; ♣"), 
                doc.Body().Html());
        }
        ...
        public virtual void HandlesInvalidDoctypes() {
            ...
            Document doc = Org.Jsoup.Jsoup.Parse("<!DOCTYPE>");
            NUnit.Framework.Assert.AreEqual("<!doctype> <html> <head></head> <body></body> </html>", Org.Jsoup.Helper.StringUtil
                .NormaliseWhitespace(doc.OuterHtml()));
            doc = Org.Jsoup.Jsoup.Parse("<!DOCTYPE><html><p>Foo</p></html>");
            NUnit.Framework.Assert.AreEqual("<!doctype> <html> <head></head> <body> <p>Foo</p> </body> </html>", Org.Jsoup.Helper.StringUtil
                .NormaliseWhitespace(doc.OuterHtml()));
        ...
        public virtual void HandlesManyChildren() {
            ...
            Document doc = Org.Jsoup.Parser.Parser.ParseBodyFragment(longBody.ToString(), "");
            // Assert
        ...
        public virtual void TestNormalisesIsIndex() {
            Document doc = Org.Jsoup.Jsoup.Parse("<body><isindex action='/submit'></body>");
            ...
            NUnit.Framework.Assert.AreEqual("<form action=\"/submit\"> <hr> <label>This is a searchable index. Enter search keywords: <input name=\"isindex\"></label> <hr> </form>"
                , Org.Jsoup.Helper.StringUtil.NormaliseWhitespace(doc.Body().Html()));
        }
