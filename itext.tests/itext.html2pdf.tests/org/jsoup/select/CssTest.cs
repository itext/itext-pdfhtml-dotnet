...
namespace Org.Jsoup.Select {
    public class CssTest {
        ...
        public virtual void Init() {
            html = Org.Jsoup.Jsoup.Parse(htmlString);
        }
        ...
        public virtual void Root() {
            ...
            NUnit.Framework.Assert.AreEqual(Org.Jsoup.Parser.Tag.ValueOf("html"), sel[0].Tag());
            ...
            NUnit.Framework.Assert.AreEqual(Org.Jsoup.Parser.Tag.ValueOf("body"), sel2[0].Tag());
        }
    }
}
