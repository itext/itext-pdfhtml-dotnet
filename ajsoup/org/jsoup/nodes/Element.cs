...
namespace Org.Jsoup.Nodes {
    ...
    public class Element : Node {
        ...
        public Element(Org.Jsoup.Parser.Tag tag, String baseUri, Attributes attributes)
        ...
        /// string, but not null.
        /// </param>
        /// <seealso cref="Org.Jsoup.Parser.Tag.ValueOf(System.String)"/>
        public Element(Org.Jsoup.Parser.Tag tag, String baseUri)
        ...
        public virtual Org.Jsoup.Nodes.Element TagName(String tagName) {
        ...
        public virtual Org.Jsoup.Parser.Tag Tag() {
            return tag;
        }
        ...
        /// <returns>this element</returns>
        public virtual Org.Jsoup.Nodes.Element Attr(String attributeKey, bool attributeValue) {
        ...
        private static void AccumulateParents(Org.Jsoup.Nodes.Element el, Elements parents) {
            Org.Jsoup.Nodes.Element parent = ((Org.Jsoup.Nodes.Element)el.Parent());
        ...
        public virtual Org.Jsoup.Nodes.Element Child(int index) {
        ...
        public virtual Elements Children() {
            ...
            IList<Org.Jsoup.Nodes.Element> elements = new List<Org.Jsoup.Nodes.Element>(childNodes.Count);
        ...
        /// <see cref="Org.Jsoup.Select.Selector"/>
        ...
        /// <seealso cref="Org.Jsoup.Select.Selector"/>
        /// <exception cref="Org.Jsoup.Select.Selector.SelectorParseException">(unchecked) on an invalid CSS query.</exception>
        ...
        public virtual Org.Jsoup.Nodes.Element AppendChild(Node child) {
        ...
        /// <param name="child">node to add.</param>
        /// <returns>this element, so that you can add more child nodes or elements.</returns>
        public virtual Org.Jsoup.Nodes.Element PrependChild(Node child) {
            Validate.NotNull(child);
            AddChildren(0, child);
            return this;
        }
        ...
        /// <returns>this element, for chaining.</returns>
        public virtual Org.Jsoup.Nodes.Element InsertChildren<_T0>(int index, ICollection<_T0> children)
            where _T0 : Node {
            ...
            List<Node> nodes = new List<Node>(children);
            Node[] nodeArray = nodes.ToArray(new Node[nodes.Count]);
        ...
        /// </returns>
        public virtual Org.Jsoup.Nodes.Element AppendElement(String tagName) {
        ...
        /// </returns>
        public virtual Org.Jsoup.Nodes.Element PrependElement(String tagName) {
            Org.Jsoup.Nodes.Element child = new Org.Jsoup.Nodes.Element(Org.Jsoup.Parser.Tag.ValueOf(tagName), BaseUri
                ());
            PrependChild(child);
            return child;
        ...
        /// <returns>this element</returns>
        public virtual Org.Jsoup.Nodes.Element AppendText(String text) {
        ...
        /// <param name="text">the unencoded text to add</param>
        /// <returns>this element</returns>
        public virtual Org.Jsoup.Nodes.Element PrependText(String text) {
            Validate.NotNull(text);
            TextNode node = new TextNode(text, BaseUri());
            PrependChild(node);
            return this;
        ...
        public virtual Org.Jsoup.Nodes.Element Append(String html) {
            Validate.NotNull(html);
            IList<Node> nodes = Org.Jsoup.Parser.Parser.ParseFragment(html, this, BaseUri());
            AddChildren(nodes.ToArray(new Node[nodes.Count]));
            return this;
        }
        ...
        /// <returns>this element</returns>
        /// <seealso cref="Html(System.String)"/>
        public virtual Org.Jsoup.Nodes.Element Prepend(String html) {
            Validate.NotNull(html);
            IList<Node> nodes = Org.Jsoup.Parser.Parser.ParseFragment(html, this, BaseUri());
            AddChildren(0, nodes.ToArray(new Node[nodes.Count]));
            return this;
        }
        ...
        public override Node Before(String html) {
            return (Org.Jsoup.Nodes.Element)base.Before(html);
        }
        ...
        public override Node Before(Node node) {
            return (Org.Jsoup.Nodes.Element)base.Before(node);
        }
        ...
        public override Node After(String html) {
            return (Org.Jsoup.Nodes.Element)base.After(html);
        }
        ...
        public override Node After(Node node) {
            return (Org.Jsoup.Nodes.Element)base.After(node);
        }
        ...
        /// <returns>this element</returns>
        public virtual Org.Jsoup.Nodes.Element Empty() {
            childNodes.Clear();
            return this;
        }
        ...
        public override Node Wrap(String html) {
            return (Org.Jsoup.Nodes.Element)base.Wrap(html);
        }
        ...
        public virtual String CssSelector() {
            ...
            String classes = Org.Jsoup.Helper.StringUtil.Join(ClassNames(), ".");
            if (classes.Length > 0) {
                selector.Append('.').Append(classes);
            }
            if (((Org.Jsoup.Nodes.Element)Parent()) == null || ((Org.Jsoup.Nodes.Element)Parent()) is Document) {
        ...
        public virtual Elements SiblingElements() {
            ...
            IList<Org.Jsoup.Nodes.Element> elements = ((Org.Jsoup.Nodes.Element)Parent()).Children();
            Elements siblings = new Elements(elements.Count - 1);
            foreach (Org.Jsoup.Nodes.Element el in elements) {
                if (el != this) {
                    siblings.Add(el);
                }
            }
        ...
        public virtual Org.Jsoup.Nodes.Element NextElementSibling() {
            if (parentNode == null) {
                return null;
            }
            IList<Org.Jsoup.Nodes.Element> siblings = ((Org.Jsoup.Nodes.Element)Parent()).Children();
        ...
        public virtual Org.Jsoup.Nodes.Element PreviousElementSibling() {
            if (parentNode == null) {
                return null;
            }
            IList<Org.Jsoup.Nodes.Element> siblings = ((Org.Jsoup.Nodes.Element)Parent()).Children();
        ...
        public virtual Org.Jsoup.Nodes.Element FirstElementSibling() {
        ...
        public virtual int ElementSiblingIndex() {
            if (((Org.Jsoup.Nodes.Element)Parent()) == null) {
                return 0;
            }
            return IndexInList(this, ((Org.Jsoup.Nodes.Element)Parent()).Children());
        }
        ...
        public virtual Org.Jsoup.Nodes.Element LastElementSibling() {
            IList<Org.Jsoup.Nodes.Element> siblings = ((Org.Jsoup.Nodes.Element)Parent()).Children();
            return siblings.Count > 1 ? siblings[siblings.Count - 1] : null;
        }

        private static int IndexInList<E>(Org.Jsoup.Nodes.Element search, IList<E> elements)
            where E : Org.Jsoup.Nodes.Element {
        ...
        public virtual Org.Jsoup.Nodes.Element GetElementById(String id) {
        ...
        private static void AppendNormalisedText(StringBuilder accum, TextNode textNode) {
            ...
            if (PreserveWhitespace(textNode.parentNode)) {
                ...
                Org.Jsoup.Helper.StringUtil.AppendNormalisedWhitespace(accum, text, TextNode.LastCharIsWhitespace(accum));
            }
        }
        ...
        internal static bool PreserveWhitespace(Node node) {
            ...
            if (node != null && node is Org.Jsoup.Nodes.Element) {
                Org.Jsoup.Nodes.Element element = (Org.Jsoup.Nodes.Element)node;
                return element.tag.PreserveWhitespace() || ((Org.Jsoup.Nodes.Element)element.Parent()) != null && ((Org.Jsoup.Nodes.Element
        ...
        /// <returns>this element</returns>
        public virtual Org.Jsoup.Nodes.Element Text(String text) {
            Validate.NotNull(text);
            Empty();
        ...
        public virtual String Data() {
            ...
            foreach (Node childNode in childNodes) {
                if (childNode is DataNode) {
                    ...
                    if (childNode is Org.Jsoup.Nodes.Element) {
        ...
        /// <returns>this element, for chaining</returns>
        public virtual Org.Jsoup.Nodes.Element ClassNames(ICollection<String> classNames) {
        ...
        /// <returns>this element</returns>
        public virtual Org.Jsoup.Nodes.Element AddClass(String className) {
        ...
        /// <returns>this element</returns>
        public virtual Org.Jsoup.Nodes.Element RemoveClass(String className) {
            Validate.NotNull(className);
            ICollection<String> classes = ClassNames();
        ...
        /// <returns>this element</returns>
        public virtual Org.Jsoup.Nodes.Element ToggleClass(String className) {
            Validate.NotNull(className);
            ICollection<String> classes = ClassNames();
        ...
        /// <returns>this element (for chaining)</returns>
        public virtual Org.Jsoup.Nodes.Element Val(String value) {
            if (TagName().Equals("textarea")) {
                Text(value);
            }
            else {
        ...
        internal override void OuterHtmlHead(StringBuilder accum, int depth, OutputSettings @out) {
            if (@out.PrettyPrint() && (tag.FormatAsBlock() || (((Org.Jsoup.Nodes.Element)Parent()) != null && ((Org.Jsoup.Nodes.Element
        ...
        public virtual Org.Jsoup.Nodes.Element Html(String html) {
            Empty();
            Append(html);
            return this;
        }
