...
namespace Org.Jsoup.Nodes {
    ...
    public class Document : Element {
        private Org.Jsoup.Nodes.OutputSettings outputSettings = new Org.Jsoup.Nodes.OutputSettings();

        private Org.Jsoup.Nodes.QuirksMode quirksMode = Org.Jsoup.Nodes.QuirksMode.noQuirks;
        ...
        /// <seealso cref="Org.Jsoup.Jsoup.Parse(System.String)"/>
        /// <seealso cref="CreateShell(System.String)"/>
        public Document(String baseUri)
            : base(Org.Jsoup.Parser.Tag.ValueOf("#root"), baseUri) {
        ...
        public static Org.Jsoup.Nodes.Document CreateShell(String baseUri) {
        ...
        public virtual Element CreateElement(String tagName) {
            return new Element(Org.Jsoup.Parser.Tag.ValueOf(tagName), this.BaseUri());
        }
        ...
        public virtual Org.Jsoup.Nodes.Document Normalise() {
        ...
        public override Object Clone() {
            Org.Jsoup.Nodes.Document clone = (Org.Jsoup.Nodes.Document)base.Clone();
            clone.outputSettings = (Org.Jsoup.Nodes.OutputSettings)this.outputSettings.Clone();
            return clone;
        }
        ...
        public virtual Org.Jsoup.Nodes.OutputSettings OutputSettings() {
        ...
        public virtual Document OutputSettings(Org.Jsoup.Nodes.OutputSettings outputSettings) {
    ...
    public class OutputSettings : ICloneable {
        ...
        private Org.Jsoup.Nodes.Syntax syntax = Org.Jsoup.Nodes.Syntax.html;

        public OutputSettings() {
            charsetEncoder = Org.Jsoup.PortUtil.NewEncoder(charset);
        }
        ...
        public virtual Org.Jsoup.Nodes.OutputSettings EscapeMode(Entities.EscapeMode escapeMode) {
        ...
        /// <returns>the document's output settings, for chaining</returns>
        public virtual Org.Jsoup.Nodes.OutputSettings Charset(Encoding charset) {
        ...
        public virtual Org.Jsoup.Nodes.Syntax Syntax() {
            return syntax;
        }
        ...
        /// <returns>the document's output settings, for chaining</returns>
        public virtual Org.Jsoup.Nodes.OutputSettings Syntax(Org.Jsoup.Nodes.Syntax syntax) {
            this.syntax = syntax;
            return this;
        }
        ...
        public virtual Org.Jsoup.Nodes.OutputSettings PrettyPrint(bool pretty) {
            prettyPrint = pretty;
            return this;
        }
        ...
        /// <returns>this, for chaining</returns>
        public virtual Org.Jsoup.Nodes.OutputSettings Outline(bool outlineMode) {
            outline = outlineMode;
            return this;
        }
        ...
        /// </param>
        /// <returns>this, for chaining</returns>
        public virtual Org.Jsoup.Nodes.OutputSettings IndentAmount(int indentAmount) {
